<template>
  <div class="context">
    <img src="../assets/images/undev.png" style="display: inline; position: relative; top: -90px; left: 230px;">
    <p style="display: inline; position: relative; top: -30px; left: -70px;color: #479BFF">此功能暂时未开通，敬请期待！</p>
    <p style="display: inline; position: relative; top: 20px; left: -335px;font-weight: bold;font-size:30px">各大区联系方式</p>
    <div>
      <i style="display: inline; position: relative; top: 50px; left: -85px;font-size:22px; color: blue" class="el-icon-s-custom"></i>
      <p style="display: inline; position: relative; top: 50px; left: -95px;font-size:18px">华北大区</p>
      <p style="display: inline; position: relative; top: 50px; left: -125px;">陈先生</p>
    ...
    <div>
      ...
      <p style="display: inline; position: relative; top: 100px; left: 62px;font-size:18px">联系电话</p>
      <p style="display: inline; position: relative; top: 100px; left: 32px; color: #ee9526;font-size:25px">18500026700</p>
    ...
    <div>
      <i style="display: inline; position: relative; top: 150px; left: 55px;font-size:22px; color: blue" class="el-icon-message"></i>
      <p style="display: inline; position: relative; top: 150px; left: 45px;font-size:18px">电子邮箱</p>
      <p style="display: inline; position: relative; top: 150px; left: 15px;">chenqiang@efreight.cn</p>
 ...
 <!--   <div>
      ...
      <div style="display: inline; position: relative; top: -104px">各大区服务电话</div>
    </div>
    <p style="font-size: small;position: relative; top: -100px">华北大区 陈先生 18500026700</p>
    <p style="font-size: small;position: relative; top: -100px">华东大区 汤先生 13816024224</p>
    <p style="font-size: small;position: relative; top: -100px">华南大区 刘女士 18928744417</p>-->
  </div>
</template>
<style scoped="scoped">
  html,body {
