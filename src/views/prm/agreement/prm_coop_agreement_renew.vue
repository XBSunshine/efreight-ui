<template>
  <el-dialog title="客户协议 - 续签" width="650px"
    ...
    <el-form :model="ruleForm" :rules="rules" ref="ruleForm" class="demo-ruleForm">
      ...
      <el-row>
        <el-col class="elementWidth">
          <el-form-item label="开始日期" prop="begin_date" required label-width="85px">
            <el-date-picker v-model="ruleForm.begin_date"  type="date" value-format="yyyy-MM-dd" placeholder="选择开始日期" style="width: 150px;">
            </el-date-picker>
          </el-form-item>
        </el-col>
        <el-col class="elementWidth">
          <el-form-item label="截止日期" prop="end_date" required label-width="185px">
              <el-date-picker v-model="ruleForm.end_date"  type="date" value-format="yyyy-MM-dd" placeholder="选择截止日期" style="width: 150px;">
            </el-date-picker>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row>
        ...
        <el-col class="elementWidth">
          <el-form-item label="合同额度" prop="total_amount" required label-width="185px">
              <el-input v-model="ruleForm.total_amount"  auto-complete="off" disabled style="width: 150px;">
              </el-input>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row>
        <el-form-item style="margin-left: 15px;">
          <el-button size="small" type="primary" @click="doRenew('ruleForm')">续签</el-button>
        </el-form-item>
      </el-row>
    </el-form>
  </el-dialog>
...
//          { required: true, message: '请输入合同备注', trigger: ['blur', 'change'] },
    ...
    created(){
     ...
     var begin_date=this.stringToDate(this.frow.begin_date,"yyyy-MM-dd","-");
     var end_date=this.stringToDate(this.frow.end_date,"yyyy-MM-dd","-");
     this.ruleForm.begin_date=end_date.getFullYear()+"-"+(end_date.getMonth()+1)+"-"+(end_date.getDate()+1);
     this.ruleForm.end_date=(end_date.getFullYear()+1)+"-"+(end_date.getMonth()+1)+"-"+end_date.getDate();
