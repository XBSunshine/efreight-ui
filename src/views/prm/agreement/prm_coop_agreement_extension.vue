<template>
  <el-dialog title="客户协议 - 延期" width="650px"
    ...
    <el-form :model="ruleForm" :rules="rules" ref="ruleForm" class="demo-ruleForm">
      ...
      <el-row>
        ...
        <el-col class="elementWidth">
          <el-form-item label="截止日期" prop="end_date" required label-width="185px">
              <el-date-picker v-model="ruleForm.end_date"  type="date" value-format="yyyy-MM-dd" placeholder="选择截止日期" :picker-options="pickerOptions0" style="width: 150px;">
            </el-date-picker>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row>
        <el-form-item style="margin-left: 15px;">
          <el-button size="small" type="primary" @click="doExtension('ruleForm')">延期</el-button>
        </el-form-item>
      </el-row>
    </el-form>
  </el-dialog>
      ...
      doExtension(formName) {
        this.$refs[formName].validate((valid) => {
          if (valid) {
            ...
            if (this.frow.end_date>this.ruleForm.end_date) {
              this.openError('截止日期不能小于原截止日期');
              return;
            }
            let params=this.ruleForm;
