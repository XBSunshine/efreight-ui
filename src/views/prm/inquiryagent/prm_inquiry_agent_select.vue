<template>
	<el-dialog title="客户 - 选择" width="750px" :visible.sync="visible" :close-on-press-escape="false" :close-on-click-modal="false" :before-close="handleClose" append-to-body>
		<div>
				...
				<el-row>
					<el-col class="elementWidth">
						<el-form-item label="代码">
							<el-input v-model="query.coopMnemonic" clearable auto-complete="off" style="width: 80px;">
							</el-input>
						</el-form-item>
					</el-col>
					<el-col class="elementWidth">
						<el-form-item label="客户名称">
							<el-input v-model="query.coopName" clearable auto-complete="off" style="width: 150px;">
							</el-input>
						</el-form-item>
					</el-col>
					<el-col class="elementWidth">
		...
		<div>
			<el-table border :data="data1">
				<el-table-column prop="coopMnemonic" label="代码" width="120" align="center"></el-table-column>
		...
		methods: {
			...
			queryList() {
				...
				let param = "size=" + this.pageConf.pageSize + "&current=" + this.pageConf.pageCode +
					"&coopMnemonic=" + this.query.coopMnemonic + "&coopName=" + this.query.coopName;
				let that = this;
				this.$axios.get('/afbase/aforder/selectPrmCoop?' + param).then(function(response) {
