<template>
	<el-dialog title="供应商 - 选择" width="800px" :visible.sync="visible" :close-on-press-escape="false" :close-on-click-modal="false" :before-close="handleClose" append-to-body>
		...
		<div>
			<el-table border :data="data1">
				...
				<el-table-column prop="coopName" label="供应商名称" header-align="center"></el-table-column>
...
<script>
	export default {
		...
		methods: {
			...
			doSelect(rrow) {
				this.setValueSupplier(rrow);
				this.handleClose();
			},
			queryList() {
				this.$axios.get2('/afbase/aforder/getCoopListNew', {
