<template>
	<el-dialog title="应付账龄 - 明细" width="1300px" :visible.sync="visible" :close-on-press-escape="false" :close-on-click-modal="false" :before-close="handleClose">
				...
				<el-col class="elementWidth">
					<el-form-item label="客户类型">
						<el-select v-model="query.customerType" style="width: 110px;">
							<el-option label="订单客户" value="0">
							</el-option>
							<el-option label="收款客户" value="1">
							</el-option>
						</el-select>
					</el-form-item>
				</el-col>
		...
		<el-table border v-loading="loading" :data="data" stripe>
			...
			<el-table-column label="主单号" prop="awbNumber" align="center" width="120" v-if="frow.businessScope!='LC'&&frow.businessScope!='IO'">
			</el-table-column>
			<el-table-column label="客户单号" prop="awbNumber" align="center" width="120" v-if="frow.businessScope=='LC'||frow.businessScope=='IO'">
			</el-table-column>
			...
			<el-table-column align="center" prop="etd" label="开航日期" width="120" v-if="frow.businessScope=='AE'||frow.businessScope=='SE'"></el-table-column>
			<el-table-column align="center" prop="etd" label="到港日期" width="120" v-if="frow.businessScope=='AI'||frow.businessScope=='SI'"></el-table-column>
      ...
      <el-table-column align="center" prop="etd" label="到达日期" width="120" v-if="frow.businessScope=='TI'"></el-table-column>
			...
			<el-table-column header-align="center" align="left" prop="coopCode" label="付款客户代码" width="100"></el-table-column>
			...
			<el-table-column align="center" prop="currency" label="币种" width="80"></el-table-column>
			<el-table-column header-align="center" align="right" prop="amount" label="付款金额(原币)" width="150"></el-table-column>
			<el-table-column header-align="center" align="right" prop="functionalAmount" label="付款金额(本币)" width="150"></el-table-column>
			<el-table-column header-align="center" align="right" prop="noAmountWriteoff" label="未核销金额(原币)" width="150"></el-table-column>
	...
	export default {
      ...
      if(this.frow.otherOrgFlag){
        this.otherOrgFlag=true;
			...
			//查询业务范畴
			let controllerUrl = ''
			if (this.frow.businessScope == 'AE' || this.frow.businessScope == 'AI') {
				controllerUrl = 'af'
			} else if (this.frow.businessScope == 'SE' || this.frow.businessScope == 'SI') {
				controllerUrl = 'sc'
			} else if (this.frow.businessScope.startsWith('T') || this.frow.businessScope.startsWith('L') || this.frow.businessScope == 'IO') {
				controllerUrl = 'page'
			}
			this.loading = true
			this.$axios.get2('/afbase/reportPayableAge/' + controllerUrl + '/view', this.frow).then(function(response) {
        ...
        if (row.businessScope === 'TI') {
			...
			exportExcel() {
				...
				this.$axios.post3('/afbase/reportPayableAge/' + controllerUrl + '/exportExcel', this.frow).then((response) => {
					...
					downloadElement.download = '应付账龄明细.xls'; // 下载后文件名
