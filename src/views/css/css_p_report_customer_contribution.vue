...
<script>
	import setVisibleVue from './customerContribution/css_p_report_customer_contribution_setting.vue'
	import columns from './customerContribution/customer_contribution.json'
  ...
  import showListVueView from './customerContribution/css_p_report_customer_contribution_detail.vue'
	export default {
		data() {
			return {
        tableH: "750px",
