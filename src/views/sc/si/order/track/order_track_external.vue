	...
	<div class="orderTrackExternal" style="position: relative;top: 0px;">
				<el-row>
					<el-card>
						...
						<el-row type="flex" justify="center">
							<el-col :sm="2" :xs="8" class="font-style port-right"> {{orderTrack.departureStation}} </el-col>
							<el-col :sm="5" :xs="5">
								<el-divider></el-divider>
							</el-col>
							<el-col :sm="2" :xs="8" class="font-style port-left"> {{orderTrack.arrivalStation}} </el-col>
						</el-row>
						...
						<el-collapse-item title="订单信息" name="orderInfo" class='item-title'>
							...
							<div class="hidden-md-and-up">
								...
								<el-row class="order-track-border">
									...
									<el-col :xs="19" class="order-track-border-right">
								...
								<el-row class="order-track-border">
									<el-col :xs="12">
										<el-col :xs="10" class="order-track-border-right order-track-border-left">
											<div class="order-track-text-center">入库日期</div>
										</el-col>
										<el-col :xs="14">
