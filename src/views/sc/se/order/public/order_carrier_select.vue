<template>
	<el-dialog title="海运出口订单 - 船公司选择" width="700px" :visible.sync="visible" :close-on-press-escape="false" :close-on-click-modal="false" :before-close="handleClose" append-to-body style="top:-80px;">
		<div class="carrierSelectPage">
			<el-form :inline="false" :model="query" label-width="10px" class="demo-ruleForm">

				<el-row>
					<el-col class="elementWidth">
						<el-form-item>
							<el-input v-model="query.shipCompanyNameCn" clearable auto-complete="off" style="width: 350px;">
		...
		<div>
			<el-table border :data="data1" stripe>
				<el-table-column prop="shipCompanyNameCn" label="船公司中文名称" header-align="center"></el-table-column>
				<el-table-column prop="shipCompanyNameEn" label="船公司英文名称" header-align="center"></el-table-column>
