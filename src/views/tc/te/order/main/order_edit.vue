<template>
	<el-dialog title="铁路订单 - 编辑" :fullscreen="ifFullscreen" width="1300px" :visible.sync="visible" :close-on-press-escape="false" :close-on-click-modal="false" :before-close="handleClose" :show-close="!ifFullscreen" :style="style">
...
<script>
	const OrderInfo = resolve => require(['@/views/tc/te/order/main/component_edit/order_edit_orderinfo.vue'], resolve)
