<template>
	<el-dialog title="铁路订单 - 查看" :fullscreen="ifFullscreen" width="1300px" :visible.sync="visible" append-to-body :close-on-press-escape="false" :close-on-click-modal="false" :before-close="handleClose" :show-close="!ifFullscreen" :style="style">
...
<script>
	const OrderInfo = resolve => require(['@/views/tc/te/order/main/component_view/order_view_orderinfo.vue'], resolve)
