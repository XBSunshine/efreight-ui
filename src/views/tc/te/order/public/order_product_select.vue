<template>
	<el-dialog title="铁路订单 - 产品选择" width="1300px" :visible.sync="visible" :close-on-press-escape="false" :close-on-click-modal="false" :before-close="handleClose" append-to-body style="top:-80px;">
		<div >
        ...
        <el-table-column prop="exitPort" label="出境口岸" header-align="center"></el-table-column>
