  ...
  export default {
    ...
    methods: {
      ...
      qrCodeCallBack(imgDataBase64){
        this.drawBorderQR(this.frow['rwbNumber'] || this.frow['orderCode'], 206, 230, imgDataBase64);
      },
    ...
    created() {
      ...
      let url = location.origin+"/#/teExternalOrderDeliveryNotice?o=" + scope+(this.frow['orderUuid'] ||"");
