<template>
	<el-dialog title="堆场仓库 - 新增" width="1200px" :visible.sync="visible" :close-on-press-escape="false" :close-on-click-modal="false" :before-close="handleClose">
		<el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="90px" class="afWareHouseSave">
            ...
            <el-col class="elementWidth">
              ...
              <el-form-item label-width="10px" prop="customsCode">
                <el-input class="widthFour2" v-model="ruleForm.customsCode" auto-complete="off" style="width: 200px;" maxlength="50" @input="ruleForm.customsCode=ruleForm.customsCode.toUpperCase()">
                  <template slot="prepend">
                    <span>海关编码</span>
                  </template>
                </el-input>
		...
		methods: {
			...
			submitForm(formName) {
				this.$refs[formName].validate((valid) => {
					if (valid) {
						this.$axios.post2('/sc/tc-warehouse/doSave', this.ruleForm)
...
<style type="text/css">
  ...
  .afWareHouseSave .widthFour2 .el-input-group__prepend {
    padding: 0 11px;
  }
