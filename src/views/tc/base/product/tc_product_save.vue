<template>
  <el-dialog title="铁路产品 - 新增" width="1100px" :visible.sync="visible" :close-on-press-escape="false" :close-on-click-modal="false" :before-close="handleClose" style="top:-80px;">
        ...
        <el-row>
          ...
          <el-col :span="6">
            <el-form-item prop="productType" label-width="10px">
              <el-input class="widthWithFourWithXing" auto-complete="off" style="width:256px;">
        ...
        <el-row>
          ...
          <el-col :span="18">
           	<el-form-item prop="customerName">
           		<el-input class="widthWithFourWithXing" readOnly v-model="ruleForm.customerName" >
           			<template slot="prepend">
      ...
      methods: {
        ...
        submitForm(formName){
          this.$refs[formName].validate((valid) => {
            if (valid) {
              this.loading = true;
              this.$axios.post2("/sc/tcProduct/save", this.ruleForm)
