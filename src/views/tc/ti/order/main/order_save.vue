		...
		<div class="orderEditPage" style="width: 1280px;">
			<el-form :model="ruleForm" :rules="rules" :inline="true" ref="ruleForm" label-width="100px" class="demo-ruleForm" style="margin-left: 10px;">
				<div style="margin-top: -15px;margin-bottom: 20px;">
					<span style="font-size: large;margin-bottom: 20px;">{{divTitle}}</span>
...
<script>
	...
	export default {
      ...
      clearParam(){
        ...
        this.ruleForm.rwbNumber = '';
        this.ruleForm.customerNumber = '';
        this.ruleForm.editorId = '';
        this.ruleForm.editorName = '';
        this.ruleForm.editTime = '';
        //申放箱
        this.ruleForm.containerApply = 0;
        this.ruleForm.containerApplyCompany = '';
        this.ruleForm.containerWarehouse ='';
        this.ruleForm.containerCommand ='';
        this.ruleForm.containerApplyRemark ='';
      ...
      this.$axios.get('/hrs/userWorkgroup/selectWorkgroup?businessScope=TI').then(function(response) {
        ...
        current: 1,
			...
			//查询签约公司默认配置信息
			this.$axios.get('/hrs/org/getOrgOrderConfig/TI').then((response) => {
				if (response.data.code == 0 && response.data.data) {
					this.ruleForm.goodsType = response.data.data.goodsType
					if (!this.ruleForm.goodsType) {
						this.ruleForm.goodsType = '普货'
					}
          this.ruleForm.productType = response.data.data.productType
          if (!this.ruleForm.productType) {
            this.ruleForm.productType = '外采产品'
          }
      ...
      if(!!this.frow.orderId){//复制新增
        this.divTitle = '铁路进口订单 - 复制新增'
        this.view();
      }
		}
	}
