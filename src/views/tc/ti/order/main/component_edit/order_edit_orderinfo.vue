<template>
      ...
      <!-- style="width: 1280px;" -->
			<el-form :model="ruleForm" :rules="rules" :inline="true" ref="ruleForm" label-width="100px" class="demo-ruleForm" style="margin-left: 10px;">
				...
				<!-- 	<span style="font-size: large;margin-bottom: 20px;">铁路出口订单&nbsp;-&nbsp;编辑</span> -->
        ...
        <el-row>
        	<el-col class="elementWidth">
        		<el-form-item prop="departureStation">
        			<el-input class="widthWithThree" v-model="ruleForm.departureStation" @input="ruleForm.departureStation=ruleForm.departureStation.toUpperCase()" maxlength="20" auto-complete="off" style="width:295px;margin-right: 15px;" clearable>
        				<template slot="prepend">
                  <font style="color: red;">*</font>
        					<span>起运地</span>
        				</template>
        	...
        	<el-col class="elementWidth">
        		<el-form-item>
        			<el-input class="widthWithThree" v-model="ruleForm.exitPort" @input="ruleForm.exitPort=ruleForm.exitPort.toUpperCase()" auto-complete="off" maxlength="20" style="width:295px;margin-right: 17px;" clearable>
        				<template slot="prepend">
        					<span>进境口岸</span>
        				</template>
        			</el-input>
        	...
        	<el-col class="elementWidth">
        		<el-form-item>
        			<el-input class="widthWithThree" v-model="ruleForm.transitStation" @input="ruleForm.transitStation=ruleForm.transitStation.toUpperCase()" maxlength="20" auto-complete="off" style="width:295px;margin-right: 15px;" clearable>
        				<template slot="prepend">
        					<span>中转地</span>
        				</template>
        			</el-input>
        	...
        	<el-col class="elementWidth">
        		<el-form-item prop="arrivalStation">
        			<el-input class="widthWithThree" v-model="ruleForm.arrivalStation"  @input="ruleForm.arrivalStation=ruleForm.arrivalStation.toUpperCase()" maxlength="20" auto-complete="off" style="width:295px;" clearable>
        				<template slot="prepend">
        	        <font style="color: red;">*</font>
        					<span>目的地</span>
        				</template>
				...
				<el-col class="elementWidth">
					<el-form-item>
						<el-input class="widthWithThree" v-model="ruleForm.overGoods" auto-complete="off" style="width:295px;" placeholder="请输入超尺、超重信息" maxlength="20" clearable>
							<template slot="prepend">
								<span>超标货物</span>
							</template>
						</el-input>
				...
				<el-row>
					...
					<el-col class="elementWidth">
						<el-form-item>
							<el-input class="widthWithThree" @input="formatToFloat('planChargeWeight')" @change="formatDecimalPlaces('planVolume')" v-model="ruleForm.planChargeWeight" auto-complete="off" style="width:295px;" clearable>
								<template slot="prepend">
									<span>计费吨</span>
								</template>
								<template slot="append">
        	...
        	<el-row style="margin-left: 50px;" v-show="showFlagPriceInfo" >
        		<el-col :span="7" >
        		  <el-form-item label="" prop="freightPrice">
        		    <el-input v-model="ruleForm.freightPrice" @input="formatToFloat('freightPrice')" @change="formatDecimalPlaces('freightPrice')"  auto-complete="off" style="width:320px;">
          ...
          <el-row v-show="showFlagPriceInfo" style="margin-left: 50px;">
          	<el-col :span="7">
          	  <el-form-item label="" prop="msrPrice">
          	    <el-input v-model="ruleForm.msrPrice" @input="formatToFloat('msrPrice')" @change="formatDecimalPlaces('msrPrice')"  auto-complete="off" style="width:320px;">
...
<script>
	...
	export default {
           ...
           this.activeOperationName = 'fxinfo'
			...
			submitForm(formName) {
				...
				this.$refs[formName].validate((valid) => {
					if (valid) {
						this.loading = true
						this.$axios.post2('/sc/tcOrder/te/modify', this.ruleForm)
							.then((response) => {
                this.findByPage()
      ...
      formatDecimalPlaces(item) {
         ...
         }else if(item == 'freightPrice' || item == 'msrPrice'){
            if (this.ruleForm[item]) {
            	let t = this.ruleForm[item].split('.');
            	if (t.length > 1) {
            		if (t[1].length < 2) {
            			this.ruleForm[item] = t[0] + "." + t[1] + "00".substr(0, 2 - t[1].length);
            		}else{
                   this.ruleForm[item] =parseFloat(t[0] + "." + t[1]).toFixed(2);
                }
            	} else {
            			this.ruleForm[item] = t[0] + "." + "00".substr(0, 2);
            	}
            }
          }
      },
        ...
        }else if (prop == 'freightPrice' || prop == 'msrPrice') {
          this.ruleForm[prop] = this.ruleForm[prop].replace(/[^0123456789.]/g, "");
      ...
      view(){
		...
		created() {
      this.$axios.get('/hrs/permission/' + 398).then(function(response) {
      	if (response.data.code == 0) {
      ...
      this.$axios.get("afbase/aforder/getCoopList", {
        businessScope: "TI",
        size: 10000,
        current: 1,
