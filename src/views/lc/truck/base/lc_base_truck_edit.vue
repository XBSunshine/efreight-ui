<template>
	<el-dialog title="车辆信息 - 修改" width="600px" :visible.sync="visible" :close-on-press-escape="false" :close-on-click-modal="false" :before-close="handleClose" style="top:-80px;">
		<div class="lc_base_truck_edit">
		...
		methods: {
			...
			submitForm(formName) {
				this.$refs[formName].validate((valid) => {
					if (valid) {
						this.loading = true;
						this.$axios.post2("/sc/lcTruck/update", this.ruleForm)
...
<style type="text/css" >
  .lc_base_truck_edit .el-input__icon {
    line-height: 30px !important;
  }
  .lc_base_truck_edit .el-input-group__prepend{
    width: 100px;
    text-align: center;
  }
</style>
