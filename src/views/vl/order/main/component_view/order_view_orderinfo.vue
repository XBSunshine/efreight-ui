				...
				<el-col class="elementWidth">
					<el-form-item>
						<el-input class="widthWithThree" style="width:245px;">
							...
							<el-select @change="changeTruck" slot="suffix" v-model="ruleForm.truckId" placeholder="请选择" style="width:148px;margin-right: -5px;">
...
<script>
	...
	export default {
		...
		methods: {
			...
			view() {
				this.vLoad = true
				this.$axios.get('/sc/vlOrder/' + this.frow.orderId).then((response) => {
