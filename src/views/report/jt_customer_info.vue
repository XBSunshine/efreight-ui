	...
	<div class="warp-main customer-info" v-loading="loading">
		<el-form :inline="false" :model="query" label-width="10px">
			...
			<el-row v-show="showFlag">
				...
				<el-col class="elementWidth">
					<el-form-item>
						<el-input class="widthWithFourWithXing" v-model="query.customerName" clearable style="width:358px">
							<template slot="prepend">
			...
			<el-row v-show="showFlag">
				...
				<el-col class="elementWidth">
					<el-form-item>
						<el-input class="widthWithFourWithXing" v-model="query.supplierName" clearable style="width:322px;margin-right: 0px;">
							<template slot="prepend">
								<span>供应商名称</span>
							</template>
      ...
      <el-row v-show="showFlag">
        <el-col class="elementWidth">
        	<el-form-item label-width="10px">
        		<el-input style="width:455px;">
        			<template slot="prepend">分公司&emsp;</template>
        			<el-select slot="suffix" v-model="query.otherOrg" filterable placeholder="请选择"  style="width: 387px;margin-right: -5px">
        ...
        <el-tab-pane label="汇总" name="countTwo">
        	<el-table border v-loading="loading" :max-height="700" :data="data.mapCount" stripe @header-dragend="cellWidth">
           ...
           <el-table-column align="center" prop="maolilvTwo" label="毛利率(同期)" width="130" header-align="center">
               ...
               <span >
				...
				<el-tab-pane label="明细" name="countThree">
					<el-table border v-loading="loading" :max-height="700" :data="dataTable" stripe @header-dragend="cellWidth">
...
<script>
	...
	import SupplierSelect from '.././css/customerContribution/selectSupplier'
	import Echarts from 'echarts';
	import worldJson from '.././css/customerContribution/world.json';
  ...
  import viewVisibleVueIO from '../io/order/main/order_view.vue'
	...
	import columns from '.././css/customerContribution/detail_column.json'
