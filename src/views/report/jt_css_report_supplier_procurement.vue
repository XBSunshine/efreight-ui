...
<script>
	import setVisibleVue from '.././css/cssPReportSupplierProcurement/css_p_report_supplier_procurement_setting.vue'
	import columns from '.././css/cssPReportSupplierProcurement/css_p_report_supplier_procurement.json'
