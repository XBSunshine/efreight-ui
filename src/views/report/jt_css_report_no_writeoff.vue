...
<script>
	import Detail from '.././css/cssReportNoWriteoff/css_report_no_writeoff_detail'
	import columns from '.././css/cssReportNoWriteoff/css_report_no_writeoff_column.json'
	import setVisibleVue from '.././css/cssReportNoWriteoff/css_report_no_writeoff_setting'
	export default {
		data() {
			return {
				tableHeight: "750px",
