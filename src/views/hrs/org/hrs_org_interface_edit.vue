<template>
	<el-dialog title="接口 - 编辑" width="600px" :visible.sync="visible" :close-on-press-escape="false" :close-on-click-modal="false" :before-close="handleClose" append-to-body>
	...
	export default {
      ...
      frow: Object
		...
		created() {
		  ...
		  this.ruleForm.orgApiConfigId = this.frow.orgApiConfigId;
      this.ruleForm.orgId = this.frow.orgId;
      this.ruleForm.apiType = this.frow.apiType;
      this.ruleForm.apiRemark = this.frow.apiRemark;
      //this.ruleForm.enable = this.frow.enable;
      if(this.frow.enable == 1){
        this.ruleForm.enable = '1';
      }else {
        this.ruleForm.enable = '0';
      }
      this.ruleForm.appid = this.frow.appid;
      this.ruleForm.authToken = this.frow.authToken;
      this.ruleForm.platform = this.frow.platform;
      this.ruleForm.function = this.frow.function;
      this.ruleForm.urlAuth = this.frow.urlAuth;
      this.ruleForm.urlPost = this.frow.urlPost;
			...
			submitForm(formName) {
				this.$refs[formName].validate((valid) => {
					if(valid) {
						...
						this.$axios.post2('/hrs/org/editInterface',
								params)
