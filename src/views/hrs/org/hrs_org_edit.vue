<template>
	<el-dialog :title="titleTop" width="850px" :visible.sync="visible" :close-on-press-escape="false" :close-on-click-modal="false" :before-close="handleClose">
		<el-form :model="ruleForm" :rules="rules" ref="ruleForm" class="demo-ruleForm">
			<el-row>
				<el-col class="elementWidth" v-if="frow.orgId!=1&&(frow.orgType==1||frow.orgType==2)">
				...
				<el-col class="elementWidth" v-else>
					<el-form-item label="签约公司名称" label-width="150px">
						<el-input v-model="ruleForm.orgName" disabled style="width: 340px;">
						</el-input>
					</el-form-item>
				</el-col>
			...
			<el-row>
				<el-col class="elementWidth">
					<el-form-item label="管理员账户" prop="adminName" required label-width="150px">
						<el-input v-model="ruleForm.adminName" auto-complete="off" style="width: 150px;" disabled>
						</el-input>
					</el-form-item>
				</el-col>
				<el-col class="elementWidth">
			...
			<el-row>
				<el-col class="elementWidth">
					<el-form-item label="管理员电话" prop="adminTel" required label-width="150px">
			...
			<el-row>
				<el-col class="elementWidth">
					<el-form-item v-if="orgFlag" label="需求人" prop="demandPersonId" required label-width="150px">
					...
					<el-form-item v-if="!orgFlag" label="需求人" prop="demandPersonIds" label-width="150px">
						<el-select v-model="ruleForm.demandPersonId" filterable placeholder="" style="width: 340px;" @change="setdemandersonName">
							<el-option v-for="item in useroptions" :key="item.id" :label="item.name" :value="item.id">
							</el-option>
						</el-select>
      ...
      <el-row v-show="billTemplate">
        ...
        <el-col class="elementWidth">
          <el-form-item label=" " label-width="16px">
            <el-upload class="el-form-item__content3 inline-block-padf" :action="actionPath" :data="uptoken" :before-upload="beforeAvatarUpload3" :on-remove="handleRemoveChange3" :on-success="handleSuccessChange3" ref="upload3" :auto-upload="true" :show-file-list="false">
              <span>AE账单模板(中文)</span>
              <el-input v-model="ruleForm.chBillTemplate" auto-complete="off" disabled style="width: 150px;">
              </el-input>
              <el-button size="mini" type="primary">上传</el-button>
            </el-upload>
            <el-button size="mini" type="danger" @click="removtePdf('chBillTemplate')">删除</el-button>
            <div class="el-upload__tip_pdf">格式：<span style="color:#409EFF">PDF</span>&nbsp;&nbsp;&nbsp;&nbsp;&emsp;&nbsp;大小：3MB</div>
          </el-form-item>
        </el-col>
        <!--<el-col class="elementWidth">
        ...
        <el-col class="elementWidth">
          <el-form-item label=" " label-width="12px">
            <el-upload class="el-form-item__content3 inline-block-padf" :action="actionPath" :accept="accept3" :data="uptoken" :before-upload="beforeAvatarUpload4" :on-remove="handleRemoveChange4" :on-success="handleSuccessChange4" ref="upload4" :auto-upload="true" :show-file-list="false">
              <span>AE账单模板(英文)</span>
              <el-input v-model="ruleForm.enBillTemplate" auto-complete="off" disabled style="width: 160px;">
              </el-input>
              <el-button size="mini" type="primary">上传</el-button>
            </el-upload>
            <el-button size="mini" type="danger" @click="removtePdf('enBillTemplate')">删除</el-button>
            <div class="el-upload__tip_pdf">格式：<span style="color:#409EFF">PDF</span>&nbsp;&nbsp;&nbsp;&nbsp;&emsp;&nbsp;大小：3MB</div>
          </el-form-item>
        </el-col>
        <!--<el-col class="elementWidth">
      ...
      <el-row v-show="billTemplate">
        <el-col class="elementWidth">
          <el-form-item label=" " label-width="16px">
            <el-upload class="el-form-item__content3 inline-block-padf" :action="actionPath" :data="uptoken" :accept="acceptExcel" :before-upload="beforeAvatarUploadExcelChAE" :on-remove="handleRemoveChangeExcelChAE" :on-success="handleSuccessChangeExcelChAE"  :auto-upload="true" :show-file-list="false">
              <span>AE账单模板(中文)</span>
              <el-input v-model="ruleForm.chBillTemplateExcel" auto-complete="off" disabled style="width: 150px;">
              </el-input>
              <el-button size="mini" type="primary">上传</el-button>
            </el-upload>
            <el-button size="mini" type="danger" @click="removtePdf('chBillTemplateExcel')">删除</el-button>
            <div class="el-upload__tip_pdf">格式：<span style="color:#F56C6C">EXCEL</span> &nbsp;&nbsp;&nbsp;&nbsp;大小：3MB</div>
          </el-form-item>
        </el-col>
        <el-col class="elementWidth">
          <el-form-item label=" " label-width="12px">
            <el-upload class="el-form-item__content3 inline-block-padf" :action="actionPath" :accept="acceptExcel" :data="uptoken" :before-upload="beforeAvatarUploadExcelEnAE" :on-remove="handleRemoveChangeExcelEnAE" :on-success="handleSuccessChangeExcelEnAE"  :auto-upload="true" :show-file-list="false">
              <span>AE账单模板(英文)</span>
              <el-input v-model="ruleForm.enBillTemplateExcel" auto-complete="off" disabled style="width: 160px;">
              </el-input>
              <el-button size="mini" type="primary">上传</el-button>
            </el-upload>
            <el-button size="mini" type="danger" @click="removtePdf('enBillTemplateExcel')">删除</el-button>
            <div class="el-upload__tip_pdf">格式：<span style="color:#F56C6C">EXCEL</span> &nbsp;&nbsp;&nbsp;&nbsp;大小：3MB</div>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row v-show="billTemplate">
        <el-col class="elementWidth">
          <el-form-item label=" " label-width="16px">
            <el-upload class="el-form-item__content3 inline-block-padf" :action="actionPath" :accept="accept3" :data="uptoken" :before-upload="beforeAvatarUploadChAi" :on-remove="handleRemoveChangeChAi" :on-success="handleSuccessChangeChAi" :auto-upload="true" :show-file-list="false">
              <span>AI账单模板(中文)</span>
              <el-input v-model="ruleForm.chBillTemplateAi" auto-complete="off" disabled style="width:150px;margin-left:5px">
              </el-input>
              <el-button size="mini" type="primary">上传</el-button>
            </el-upload>
            <el-button size="mini" type="danger" @click="removtePdf('chBillTemplateAi')">删除</el-button>
            <div class="el-upload__tip_pdf">格式：<span style="color:#409EFF">PDF</span>&nbsp;&nbsp;&nbsp;&nbsp;&emsp;&nbsp;大小：3MB</div>
          </el-form-item>
        </el-col>
        <el-col class="elementWidth">
          <el-form-item label=" " label-width="12px">
            <el-upload class="el-form-item__content3 inline-block-padf" :action="actionPath" :accept="accept3" :data="uptoken" :before-upload="beforeAvatarUploadEnAi" :on-remove="handleRemoveChangeEnAi" :on-success="handleSuccessChangeEnAi" :auto-upload="true" :show-file-list="false">
              <span>AI账单模板(英文)</span>
              <el-input v-model="ruleForm.enBillTemplateAi" auto-complete="off" disabled style="width: 160px;margin-left:5px;">
              </el-input>
              <el-button size="mini" type="primary">上传</el-button>
            </el-upload>
            <el-button size="mini" type="danger" @click="removtePdf('enBillTemplateAi')">删除</el-button>
            <div class="el-upload__tip_pdf">格式：<span style="color:#409EFF">PDF</span>&nbsp;&nbsp;&nbsp;&nbsp;&emsp;&nbsp;大小：3MB</div>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row v-show="billTemplate">
        <el-col class="elementWidth">
          <el-form-item label=" " label-width="16px">
            <el-upload class="el-form-item__content3 inline-block-padf" :action="actionPath" :accept="acceptExcel" :data="uptoken" :before-upload="beforeAvatarUploadExcelChAi" :on-remove="handleRemoveChangeExcelChAi" :on-success="handleSuccessChangeExcelChAi" :auto-upload="true" :show-file-list="false">
              <span>AI账单模板(中文)</span>
              <el-input v-model="ruleForm.chBillTemplateAiExcel" auto-complete="off" disabled style="width:150px;margin-left:5px">
              </el-input>
              <el-button size="mini" type="primary">上传</el-button>
            </el-upload>
            <el-button size="mini" type="danger" @click="removtePdf('chBillTemplateAiExcel')">删除</el-button>
            <div class="el-upload__tip_pdf">格式：<span style="color:#F56C6C">EXCEL</span>&nbsp;&nbsp;&nbsp;&nbsp;大小：3MB</div>
          </el-form-item>
        </el-col>
        <el-col class="elementWidth">
          <el-form-item label=" " label-width="12px">
            <el-upload class="el-form-item__content3 inline-block-padf" :action="actionPath" :accept="acceptExcel" :data="uptoken" :before-upload="beforeAvatarUploadExcelEnAi" :on-remove="handleRemoveChangeExcelEnAi" :on-success="handleSuccessChangeExcelEnAi" :auto-upload="true" :show-file-list="false">
              <span>AI账单模板(英文)</span>
              <el-input v-model="ruleForm.enBillTemplateAiExcel" auto-complete="off" disabled style="width: 160px;margin-left:5px;">
              </el-input>
              <el-button size="mini" type="primary">上传</el-button>
            </el-upload>
            <el-button size="mini" type="danger" @click="removtePdf('enBillTemplateAiExcel')">删除</el-button>
            <div class="el-upload__tip_pdf">格式：<span style="color:#F56C6C">EXCEL</span>&nbsp;&nbsp;&nbsp;&nbsp;大小：3MB</div>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row v-show="billTemplate">
        <el-col class="elementWidth">
          <el-form-item label=" " label-width="16px">
            <el-upload class="el-form-item__content3 inline-block-padf" :action="actionPath" :accept="accept3" :data="uptoken" :before-upload="beforeAvatarUploadChSe" :on-remove="handleRemoveChangeChSe" :on-success="handleSuccessChangeChSe" :auto-upload="true" :show-file-list="false">
              <span>SE账单模板(中文)</span>
              <el-input v-model="ruleForm.chBillTemplateSe" auto-complete="off" disabled style="width: 150px;">
              </el-input>
              <el-button size="mini" type="primary">上传</el-button>
            </el-upload>
            <el-button size="mini" type="danger" @click="removtePdf('chBillTemplateSe')">删除</el-button>
            <div class="el-upload__tip_pdf">格式：<span style="color:#409EFF">PDF</span>&nbsp;&nbsp;&nbsp;&nbsp;&emsp;&nbsp;大小：3MB</div>
          </el-form-item>
        </el-col>
        <el-col class="elementWidth">
          <el-form-item label=" " label-width="12px">
            <el-upload class="el-form-item__content3 inline-block-padf" :action="actionPath" :accept="accept3" :data="uptoken" :before-upload="beforeAvatarUploadEnSe" :on-remove="handleRemoveChangeEnSe" :on-success="handleSuccessChangeEnSe" :auto-upload="true" :show-file-list="false">
              <span>SE账单模板(英文)</span>
              <el-input v-model="ruleForm.enBillTemplateSe" auto-complete="off" disabled style="width: 160px;">
              </el-input>
              <el-button size="mini" type="primary">上传</el-button>
            </el-upload>
            <el-button size="mini" type="danger" @click="removtePdf('enBillTemplateSe')">删除</el-button>
            <div class="el-upload__tip_pdf">格式：<span style="color:#409EFF">PDF</span>&nbsp;&nbsp;&nbsp;&nbsp;&emsp;&nbsp;大小：3MB</div>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row v-show="billTemplate">
        <el-col class="elementWidth">
          <el-form-item label=" " label-width="16px">
            <el-upload class="el-form-item__content3 inline-block-padf" :action="actionPath" :accept="acceptExcel" :data="uptoken" :before-upload="beforeAvatarUploadExcelChSe" :on-remove="handleRemoveChangeExcelChSe" :on-success="handleSuccessChangeExcelChSe" :auto-upload="true" :show-file-list="false">
              <span>SE账单模板(中文)</span>
              <el-input v-model="ruleForm.chBillTemplateSeExcel" auto-complete="off" disabled style="width: 150px;">
              </el-input>
              <el-button size="mini" type="primary">上传</el-button>
            </el-upload>
            <el-button size="mini" type="danger" @click="removtePdf('chBillTemplateSeExcel')">删除</el-button>
            <div class="el-upload__tip_pdf">格式：<span style="color:#F56C6C">EXCEL</span>&nbsp;&nbsp;&nbsp;&nbsp;大小：3MB</div>
          </el-form-item>
        </el-col>
        <el-col class="elementWidth">
          <el-form-item label=" " label-width="12px">
            <el-upload class="el-form-item__content3 inline-block-padf" :action="actionPath" :accept="acceptExcel" :data="uptoken" :before-upload="beforeAvatarUploadExcelEnSe" :on-remove="handleRemoveChangeExcelEnSe" :on-success="handleSuccessChangeExcelEnSe" :auto-upload="true" :show-file-list="false">
              <span>SE账单模板(英文)</span>
              <el-input v-model="ruleForm.enBillTemplateSeExcel" auto-complete="off" disabled style="width: 160px;">
              </el-input>
              <el-button size="mini" type="primary">上传</el-button>
            </el-upload>
            <el-button size="mini" type="danger" @click="removtePdf('enBillTemplateSeExcel')">删除</el-button>
            <div class="el-upload__tip_pdf">格式：<span style="color:#F56C6C">EXCEL</span>&nbsp;&nbsp;&nbsp;&nbsp;大小：3MB</div>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row v-show="billTemplate">
        <el-col class="elementWidth">
          <el-form-item label=" " label-width="16px">
            <el-upload class="el-form-item__content3 inline-block-padf" :action="actionPath" :accept="accept3" :data="uptoken" :before-upload="beforeAvatarUploadChSi" :on-remove="handleRemoveChangeChSi" :on-success="handleSuccessChangeChSi" :auto-upload="true" :show-file-list="false">
              <span>SI账单模板(中文)</span>
              <el-input v-model="ruleForm.chBillTemplateSi" auto-complete="off" disabled style="width: 150px;margin-left:5px;">
              </el-input>
              <el-button size="mini" type="primary">上传</el-button>
            </el-upload>
            <el-button size="mini" type="danger" @click="removtePdf('chBillTemplateSi')">删除</el-button>
            <div class="el-upload__tip_pdf">格式：<span style="color:#409EFF">PDF</span>&nbsp;&nbsp;&nbsp;&nbsp;&emsp;&nbsp;大小：3MB</div>
          </el-form-item>
        </el-col>
        <el-col class="elementWidth">
          <el-form-item label=" " label-width="12px">
            <el-upload class="el-form-item__content3 inline-block-padf" :action="actionPath" :accept="accept3" :data="uptoken" :before-upload="beforeAvatarUploadEnSi" :on-remove="handleRemoveChangeEnSi" :on-success="handleSuccessChangeEnSi" :auto-upload="true" :show-file-list="false">
              <span>SI账单模板(英文)</span>
              <el-input v-model="ruleForm.enBillTemplateSi" auto-complete="off" disabled style="width: 160px;margin-left:5px;">
              </el-input>
              <el-button size="mini" type="primary">上传</el-button>
            </el-upload>
            <el-button size="mini" type="danger" @click="removtePdf('enBillTemplateSi')">删除</el-button>
            <div class="el-upload__tip_pdf">格式：<span style="color:#409EFF">PDF</span>&nbsp;&nbsp;&nbsp;&nbsp;&emsp;&nbsp;大小：3MB</div>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row v-show="billTemplate">
        <el-col class="elementWidth">
          <el-form-item label=" " label-width="16px">
            <el-upload class="el-form-item__content3 inline-block-padf" :action="actionPath" :accept="acceptExcel" :data="uptoken" :before-upload="beforeAvatarUploadExcelChSi" :on-remove="handleRemoveChangeExcelChSi" :on-success="handleSuccessChangeExcelChSi" :auto-upload="true" :show-file-list="false">
              <span>SI账单模板(中文)</span>
              <el-input v-model="ruleForm.chBillTemplateSiExcel" auto-complete="off" disabled style="width: 150px;margin-left:5px;">
              </el-input>
              <el-button size="mini" type="primary">上传</el-button>
            </el-upload>
            <el-button size="mini" type="danger" @click="removtePdf('chBillTemplateSiExcel')">删除</el-button>
            <div class="el-upload__tip_pdf">格式：<span style="color:#F56C6C">EXCEL</span>&nbsp;&nbsp;&nbsp;&nbsp;大小：3MB</div>
          </el-form-item>
        </el-col>
        <el-col class="elementWidth">
          <el-form-item label=" " label-width="12px">
            <el-upload class="el-form-item__content3 inline-block-padf" :action="actionPath" :accept="acceptExcel" :data="uptoken" :before-upload="beforeAvatarUploadExcelEnSi" :on-remove="handleRemoveChangeExcelEnSi" :on-success="handleSuccessChangeExcelEnSi" :auto-upload="true" :show-file-list="false">
              <span>SI账单模板(英文)</span>
              <el-input v-model="ruleForm.enBillTemplateSiExcel" auto-complete="off" disabled style="width: 160px;margin-left:5px;">
              </el-input>
              <el-button size="mini" type="primary">上传</el-button>
            </el-upload>
            <el-button size="mini" type="danger" @click="removtePdf('enBillTemplateSiExcel')">删除</el-button>
            <div class="el-upload__tip_pdf">格式：<span style="color:#F56C6C">EXCEL</span>&nbsp;&nbsp;&nbsp;&nbsp;大小：3MB</div>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row v-show="billTemplate">
        <el-col class="elementWidth">
          <el-form-item label=" " label-width="16px">
            <el-upload class="el-form-item__content3 inline-block-padf" :action="actionPath" :accept="accept3" :data="uptoken" :before-upload="beforeAvatarUploadChTe" :on-remove="handleRemoveChangeChTe" :on-success="handleSuccessChangeChTe" :auto-upload="true" :show-file-list="false">
              <span>TE账单模板(中文)</span>
              <el-input v-model="ruleForm.chBillTemplateTe" auto-complete="off" disabled style="width: 150px;">
              </el-input>
              <el-button size="mini" type="primary">上传</el-button>
            </el-upload>
            <el-button size="mini" type="danger" @click="removtePdf('chBillTemplateTe')">删除</el-button>
            <div class="el-upload__tip_pdf">格式：<span style="color:#409EFF">PDF</span>&nbsp;&nbsp;&nbsp;&nbsp;&emsp;&nbsp;大小：3MB</div>
          </el-form-item>
        </el-col>
        <el-col class="elementWidth">
          <el-form-item label=" " label-width="12px">
            <el-upload class="el-form-item__content3 inline-block-padf" :action="actionPath" :accept="accept3" :data="uptoken" :before-upload="beforeAvatarUploadEnTe" :on-remove="handleRemoveChangeEnTe" :on-success="handleSuccessChangeEnTe" :auto-upload="true" :show-file-list="false">
              <span>TE账单模板(英文)</span>
              <el-input v-model="ruleForm.enBillTemplateTe" auto-complete="off" disabled style="width: 160px;">
              </el-input>
              <el-button size="mini" type="primary">上传</el-button>
            </el-upload>
            <el-button size="mini" type="danger" @click="removtePdf('enBillTemplateTe')">删除</el-button>
            <div class="el-upload__tip_pdf">格式：<span style="color:#409EFF">PDF</span>&nbsp;&nbsp;&nbsp;&nbsp;&emsp;&nbsp;大小：3MB</div>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row v-show="billTemplate">
        <el-col class="elementWidth">
          <el-form-item label=" " label-width="16px">
            <el-upload class="el-form-item__content3 inline-block-padf" :action="actionPath" :accept="acceptExcel" :data="uptoken" :before-upload="beforeAvatarUploadExcelChTe" :on-remove="handleRemoveChangeExcelChTe" :on-success="handleSuccessChangeExcelChTe" :auto-upload="true" :show-file-list="false">
              <span>TE账单模板(中文)</span>
              <el-input v-model="ruleForm.chBillTemplateTeExcel" auto-complete="off" disabled style="width: 150px;">
              </el-input>
              <el-button size="mini" type="primary">上传</el-button>
            </el-upload>
            <el-button size="mini" type="danger" @click="removtePdf('chBillTemplateTeExcel')">删除</el-button>
            <div class="el-upload__tip_pdf">格式：<span style="color:#F56C6C">EXCEL</span>&nbsp;&nbsp;&nbsp;&nbsp;大小：3MB</div>
          </el-form-item>
        </el-col>
        <el-col class="elementWidth">
          <el-form-item label=" " label-width="12px">
            <el-upload class="el-form-item__content3 inline-block-padf" :action="actionPath" :accept="acceptExcel" :data="uptoken" :before-upload="beforeAvatarUploadExcelEnTe" :on-remove="handleRemoveChangeExcelEnTe" :on-success="handleSuccessChangeExcelEnTe" :auto-upload="true" :show-file-list="false">
              <span>TE账单模板(英文)</span>
              <el-input v-model="ruleForm.enBillTemplateTeExcel" auto-complete="off" disabled style="width: 160px;">
              </el-input>
              <el-button size="mini" type="primary">上传</el-button>
            </el-upload>
            <el-button size="mini" type="danger" @click="removtePdf('enBillTemplateTeExcel')">删除</el-button>
            <div class="el-upload__tip_pdf">格式：<span style="color:#F56C6C">EXCEL</span>&nbsp;&nbsp;&nbsp;&nbsp;大小：3MB</div>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row v-show="billTemplate">
        <el-col class="elementWidth">
          <el-form-item label=" " label-width="16px">
            <el-upload class="el-form-item__content3 inline-block-padf" :action="actionPath" :accept="accept3" :data="uptoken" :before-upload="beforeAvatarUploadChTi" :on-remove="handleRemoveChangeChTi" :on-success="handleSuccessChangeChTi" :auto-upload="true" :show-file-list="false">
              <span>TI账单模板(中文)</span>
              <el-input v-model="ruleForm.chBillTemplateTi" auto-complete="off" disabled style="width: 150px;margin-left:5px;">
              </el-input>
              <el-button size="mini" type="primary">上传</el-button>
            </el-upload>
            <el-button size="mini" type="danger" @click="removtePdf('chBillTemplateTi')">删除</el-button>
            <div class="el-upload__tip_pdf">格式：<span style="color:#409EFF">PDF</span>&nbsp;&nbsp;&nbsp;&nbsp;&emsp;&nbsp;大小：3MB</div>
          </el-form-item>
        </el-col>
        <el-col class="elementWidth">
          <el-form-item label=" " label-width="12px">
            <el-upload class="el-form-item__content3 inline-block-padf" :action="actionPath" :accept="accept3" :data="uptoken" :before-upload="beforeAvatarUploadEnTi" :on-remove="handleRemoveChangeEnTi" :on-success="handleSuccessChangeEnTi" :auto-upload="true" :show-file-list="false">
              <span>TI账单模板(英文)</span>
              <el-input v-model="ruleForm.enBillTemplateTi" auto-complete="off" disabled style="width: 160px;margin-left:5px;">
              </el-input>
              <el-button size="mini" type="primary">上传</el-button>
            </el-upload>
            <el-button size="mini" type="danger" @click="removtePdf('enBillTemplateTi')">删除</el-button>
            <div class="el-upload__tip_pdf">格式：<span style="color:#409EFF">PDF</span>&nbsp;&nbsp;&nbsp;&nbsp;&emsp;&nbsp;大小：3MB</div>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row v-show="billTemplate">
        <el-col class="elementWidth">
          <el-form-item label=" " label-width="16px">
            <el-upload class="el-form-item__content3 inline-block-padf" :action="actionPath" :accept="acceptExcel" :data="uptoken" :before-upload="beforeAvatarUploadExcelChTi" :on-remove="handleRemoveChangeExcelChTi" :on-success="handleSuccessChangeExcelChTi" :auto-upload="true" :show-file-list="false">
              <span>TI账单模板(中文)</span>
              <el-input v-model="ruleForm.chBillTemplateTiExcel" auto-complete="off" disabled style="width: 150px;margin-left:5px;">
              </el-input>
              <el-button size="mini" type="primary">上传</el-button>
            </el-upload>
            <el-button size="mini" type="danger" @click="removtePdf('chBillTemplateTiExcel')">删除</el-button>
            <div class="el-upload__tip_pdf">格式：<span style="color:#F56C6C">EXCEL</span>&nbsp;&nbsp;&nbsp;&nbsp;大小：3MB</div>
          </el-form-item>
        </el-col>
        <el-col class="elementWidth">
          <el-form-item label=" " label-width="12px">
            <el-upload class="el-form-item__content3 inline-block-padf" :action="actionPath" :accept="acceptExcel" :data="uptoken" :before-upload="beforeAvatarUploadExcelEnTi" :on-remove="handleRemoveChangeExcelEnTi" :on-success="handleSuccessChangeExcelEnTi" :auto-upload="true" :show-file-list="false">
              <span>TI账单模板(英文)</span>
              <el-input v-model="ruleForm.enBillTemplateTiExcel" auto-complete="off" disabled style="width: 160px;margin-left:5px;">
              </el-input>
              <el-button size="mini" type="primary">上传</el-button>
            </el-upload>
            <el-button size="mini" type="danger" @click="removtePdf('enBillTemplateTiExcel')">删除</el-button>
            <div class="el-upload__tip_pdf">格式：<span style="color:#F56C6C">EXCEL</span>&nbsp;&nbsp;&nbsp;&nbsp;大小：3MB</div>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row v-show="billTemplate">
        <el-col class="elementWidth">
          <el-form-item label=" " label-width="16px">
            <el-upload class="el-form-item__content3 inline-block-padf" :action="actionPath" :accept="accept3" :data="uptoken" :before-upload="beforeAvatarUploadChLc" :on-remove="handleRemoveChangeChLc" :on-success="handleSuccessChangeChLc" :auto-upload="true" :show-file-list="false">
              <span>LC账单模板(中文)</span>
              <el-input v-model="ruleForm.chBillTemplateLc" auto-complete="off" disabled style="width: 150px">
              </el-input>
              <el-button size="mini" type="primary">上传</el-button>
            </el-upload>
            <el-button size="mini" type="danger" @click="removtePdf('chBillTemplateLc')">删除</el-button>
            <div class="el-upload__tip_pdf">格式：<span style="color:#409EFF">PDF</span>&nbsp;&nbsp;&nbsp;&nbsp;&emsp;&nbsp;大小：3MB</div>
          </el-form-item>
        </el-col>
        <el-col class="elementWidth">
          <el-form-item label=" " label-width="12px">
            <el-upload class="el-form-item__content3 inline-block-padf" :action="actionPath" :accept="accept3" :data="uptoken" :before-upload="beforeAvatarUploadEnLc" :on-remove="handleRemoveChangeEnLc" :on-success="handleSuccessChangeEnLc" :auto-upload="true" :show-file-list="false">
              <span>LC账单模板(英文)</span>
              <el-input v-model="ruleForm.enBillTemplateLc" auto-complete="off" disabled style="width: 160px">
              </el-input>
              <el-button size="mini" type="primary">上传</el-button>
            </el-upload>
            <el-button size="mini" type="danger" @click="removtePdf('enBillTemplateLc')">删除</el-button>
            <div class="el-upload__tip_pdf">格式：<span style="color:#409EFF">PDF</span>&nbsp;&nbsp;&nbsp;&nbsp;&emsp;&nbsp;大小：3MB</div>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row v-show="billTemplate">
        <el-col class="elementWidth">
          <el-form-item label=" " label-width="16px">
            <el-upload class="el-form-item__content3 inline-block-padf" :action="actionPath" :accept="acceptExcel" :data="uptoken" :before-upload="beforeAvatarUploadExcelChLc" :on-remove="handleRemoveChangeExcelChLc" :on-success="handleSuccessChangeExcelChLc" :auto-upload="true" :show-file-list="false">
              <span>LC账单模板(中文)</span>
              <el-input v-model="ruleForm.chBillTemplateLcExcel" auto-complete="off" disabled style="width: 150px;">
              </el-input>
              <el-button size="mini" type="primary">上传</el-button>
            </el-upload>
            <el-button size="mini" type="danger" @click="removtePdf('chBillTemplateLcExcel')">删除</el-button>
            <div class="el-upload__tip_pdf">格式：<span style="color:#F56C6C">EXCEL</span>&nbsp;&nbsp;&nbsp;&nbsp;大小：3MB</div>
          </el-form-item>
        </el-col>
        <el-col class="elementWidth">
          <el-form-item label=" " label-width="12px">
            <el-upload class="el-form-item__content3 inline-block-padf" :action="actionPath" :accept="acceptExcel" :data="uptoken" :before-upload="beforeAvatarUploadExcelEnLc" :on-remove="handleRemoveChangeExcelEnLc" :on-success="handleSuccessChangeExcelEnLc" :auto-upload="true" :show-file-list="false">
              <span>LC账单模板(英文)</span>
              <el-input v-model="ruleForm.enBillTemplateLcExcel" auto-complete="off" disabled style="width: 160px;">
              </el-input>
              <el-button size="mini" type="primary">上传</el-button>
            </el-upload>
            <el-button size="mini" type="danger" @click="removtePdf('enBillTemplateLcExcel')">删除</el-button>
            <div class="el-upload__tip_pdf">格式：<span style="color:#F56C6C">EXCEL</span>&nbsp;&nbsp;&nbsp;&nbsp;大小：3MB</div>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row v-show="billTemplate">
        <el-col class="elementWidth">
          <el-form-item label=" " label-width="16px">
            <el-upload class="el-form-item__content3 inline-block-padf" :action="actionPath" :accept="accept3" :data="uptoken" :before-upload="beforeAvatarUploadChIo" :on-remove="handleRemoveChangeChIo" :on-success="handleSuccessChangeChIo" :auto-upload="true" :show-file-list="false">
              <span>IO账单模板(中文)</span>
              <el-input v-model="ruleForm.chBillTemplateIo" auto-complete="off" disabled style="width: 150px">
              </el-input>
              <el-button size="mini" type="primary">上传</el-button>
            </el-upload>
            <el-button size="mini" type="danger" @click="removtePdf('chBillTemplateIo')">删除</el-button>
            <div class="el-upload__tip_pdf">格式：<span style="color:#409EFF">PDF</span>&nbsp;&nbsp;&nbsp;&nbsp;&emsp;&nbsp;大小：3MB</div>
          </el-form-item>
        </el-col>
        <el-col class="elementWidth">
          <el-form-item label=" " label-width="12px">
            <el-upload class="el-form-item__content3 inline-block-padf" :action="actionPath" :accept="accept3" :data="uptoken" :before-upload="beforeAvatarUploadEnIo" :on-remove="handleRemoveChangeEnIo" :on-success="handleSuccessChangeEnIo" :auto-upload="true" :show-file-list="false">
              <span>IO账单模板(英文)</span>
              <el-input v-model="ruleForm.enBillTemplateIo" auto-complete="off" disabled style="width: 160px">
              </el-input>
              <el-button size="mini" type="primary">上传</el-button>
            </el-upload>
            <el-button size="mini" type="danger" @click="removtePdf('enBillTemplateIo')">删除</el-button>
            <div class="el-upload__tip_pdf">格式：<span style="color:#409EFF">PDF</span>&nbsp;&nbsp;&nbsp;&nbsp;&emsp;&nbsp;大小：3MB</div>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row v-show="billTemplate">
        <el-col class="elementWidth">
          <el-form-item label=" " label-width="16px">
            <el-upload class="el-form-item__content3 inline-block-padf" :action="actionPath" :accept="acceptExcel" :data="uptoken" :before-upload="beforeAvatarUploadExcelChIo" :on-remove="handleRemoveChangeExcelChIo" :on-success="handleSuccessChangeExcelChIo" :auto-upload="true" :show-file-list="false">
              <span>IO账单模板(中文)</span>
              <el-input v-model="ruleForm.chBillTemplateIoExcel" auto-complete="off" disabled style="width: 150px;">
              </el-input>
              <el-button size="mini" type="primary">上传</el-button>
            </el-upload>
            <el-button size="mini" type="danger" @click="removtePdf('chBillTemplateIoExcel')">删除</el-button>
            <div class="el-upload__tip_pdf">格式：<span style="color:#F56C6C">EXCEL</span>&nbsp;&nbsp;&nbsp;&nbsp;大小：3MB</div>
          </el-form-item>
        </el-col>
        <el-col class="elementWidth">
          <el-form-item label=" " label-width="12px">
            <el-upload class="el-form-item__content3 inline-block-padf" :action="actionPath" :accept="acceptExcel" :data="uptoken" :before-upload="beforeAvatarUploadExcelEnIo" :on-remove="handleRemoveChangeExcelEnIo" :on-success="handleSuccessChangeExcelEnIo" :auto-upload="true" :show-file-list="false">
              <span>IO账单模板(英文)</span>
              <el-input v-model="ruleForm.enBillTemplateIoExcel" auto-complete="off" disabled style="width: 160px;">
              </el-input>
              <el-button size="mini" type="primary">上传</el-button>
            </el-upload>
            <el-button size="mini" type="danger" @click="removtePdf('enBillTemplateIoExcel')">删除</el-button>
            <div class="el-upload__tip_pdf">格式：<span style="color:#F56C6C">EXCEL</span>&nbsp;&nbsp;&nbsp;&nbsp;大小：3MB</div>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row v-show="inventoryTemplate">
        <el-col class="elementWidth">
          <el-form-item label=" " label-width="16px">
            <el-upload class="el-form-item__content3 inline-block-padf" :action="actionPath" :accept="acceptExcel" :data="uptoken" :before-upload="beforeAvatarUploadExcelChAeSt" :on-remove="handleRemoveChangeExcelChAeSt" :on-success="handleSuccessChangeExcelChAeSt" :auto-upload="true" :show-file-list="false">
              <span>AE清单模板(中文)</span>
              <el-input v-model="ruleForm.statementTemplateAeExcelCn" auto-complete="off" disabled style="width: 150px;">
              </el-input>
              <el-button size="mini" type="primary">上传</el-button>
            </el-upload>
            <el-button size="mini" type="danger" @click="removtePdf('statementTemplateAeExcelCn')">删除</el-button>
            <div class="el-upload__tip_pdf">格式：<span style="color:#F56C6C">EXCEL</span>&nbsp;&nbsp;&nbsp;&nbsp;大小：3MB</div>
          </el-form-item>
        </el-col>
        <el-col class="elementWidth">
          <el-form-item label=" " label-width="12px">
            <el-upload class="el-form-item__content3 inline-block-padf" :action="actionPath" :accept="acceptExcel" :data="uptoken" :before-upload="beforeAvatarUploadExcelEnAeSt" :on-remove="handleRemoveChangeExcelEnAeSt" :on-success="handleSuccessChangeExcelEnAeSt" :auto-upload="true" :show-file-list="false">
              <span>AE清单模板(英文)</span>
              <el-input v-model="ruleForm.statementTemplateAeExcelEn" auto-complete="off" disabled style="width: 160px;">
              </el-input>
              <el-button size="mini" type="primary">上传</el-button>
            </el-upload>
            <el-button size="mini" type="danger" @click="removtePdf('statementTemplateAeExcelEn')">删除</el-button>
            <div class="el-upload__tip_pdf">格式：<span style="color:#F56C6C">EXCEL</span>&nbsp;&nbsp;&nbsp;&nbsp;大小：3MB</div>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row v-show="inventoryTemplate">
        <el-col class="elementWidth">
          <el-form-item label=" " label-width="16px">
            <el-upload class="el-form-item__content3 inline-block-padf" :action="actionPath" :accept="acceptExcel" :data="uptoken" :before-upload="beforeAvatarUploadExcelChAiSt" :on-remove="handleRemoveChangeExcelChAiSt" :on-success="handleSuccessChangeExcelChAiSt" :auto-upload="true" :show-file-list="false">
              <span>AI清单模板(中文)</span>
              <el-input v-model="ruleForm.statementTemplateAiExcelCn" auto-complete="off" disabled style="width: 150px;margin-left:5px;">
              </el-input>
              <el-button size="mini" type="primary">上传</el-button>
            </el-upload>
            <el-button size="mini" type="danger" @click="removtePdf('statementTemplateAiExcelCn')">删除</el-button>
            <div class="el-upload__tip_pdf">格式：<span style="color:#F56C6C">EXCEL</span>&nbsp;&nbsp;&nbsp;&nbsp;大小：3MB</div>
          </el-form-item>
        </el-col>
        <el-col class="elementWidth">
          <el-form-item label=" " label-width="12px">
            <el-upload class="el-form-item__content3 inline-block-padf" :action="actionPath" :accept="acceptExcel" :data="uptoken" :before-upload="beforeAvatarUploadExcelEnAiSt" :on-remove="handleRemoveChangeExcelEnAiSt" :on-success="handleSuccessChangeExcelEnAiSt" :auto-upload="true" :show-file-list="false">
              <span>AI清单模板(英文)</span>
              <el-input v-model="ruleForm.statementTemplateAiExcelEn" auto-complete="off" disabled style="width: 160px;margin-left:5px;">
              </el-input>
              <el-button size="mini" type="primary">上传</el-button>
            </el-upload>
            <el-button size="mini" type="danger" @click="removtePdf('statementTemplateAiExcelEn')">删除</el-button>
            <div class="el-upload__tip_pdf">格式：<span style="color:#F56C6C">EXCEL</span>&nbsp;&nbsp;&nbsp;&nbsp;大小：3MB</div>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row v-show="inventoryTemplate">
        <el-col class="elementWidth">
          <el-form-item label=" " label-width="16px">
            <el-upload class="el-form-item__content3 inline-block-padf" :action="actionPath" :accept="acceptExcel" :data="uptoken" :before-upload="beforeAvatarUploadExcelChSeSt" :on-remove="handleRemoveChangeExcelChSeSt" :on-success="handleSuccessChangeExcelChSeSt" :auto-upload="true" :show-file-list="false">
              <span>SE清单模板(中文)</span>
              <el-input v-model="ruleForm.statementTemplateSeExcelCn" auto-complete="off" disabled style="width: 150px;">
              </el-input>
              <el-button size="mini" type="primary">上传</el-button>
            </el-upload>
            <el-button size="mini" type="danger" @click="removtePdf('statementTemplateSeExcelCn')">删除</el-button>
            <div class="el-upload__tip_pdf">格式：<span style="color:#F56C6C">EXCEL</span>&nbsp;&nbsp;&nbsp;&nbsp;大小：3MB</div>
          </el-form-item>
        </el-col>
        <el-col class="elementWidth">
          <el-form-item label=" " label-width="12px">
            <el-upload class="el-form-item__content3 inline-block-padf" :action="actionPath" :accept="acceptExcel" :data="uptoken" :before-upload="beforeAvatarUploadExcelEnSeSt" :on-remove="handleRemoveChangeExcelEnSeSt" :on-success="handleSuccessChangeExcelEnSeSt" :auto-upload="true" :show-file-list="false">
              <span>SE清单模板(英文)</span>
              <el-input v-model="ruleForm.statementTemplateSeExcelEn" auto-complete="off" disabled style="width: 160px;">
              </el-input>
              <el-button size="mini" type="primary">上传</el-button>
            </el-upload>
            <el-button size="mini" type="danger" @click="removtePdf('statementTemplateSeExcelEn')">删除</el-button>
            <div class="el-upload__tip_pdf">格式：<span style="color:#F56C6C">EXCEL</span>&nbsp;&nbsp;&nbsp;&nbsp;大小：3MB</div>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row v-show="inventoryTemplate">
        <el-col class="elementWidth">
          <el-form-item label=" " label-width="16px">
            <el-upload class="el-form-item__content3 inline-block-padf" :action="actionPath" :accept="acceptExcel" :data="uptoken" :before-upload="beforeAvatarUploadExcelChSiSt" :on-remove="handleRemoveChangeExcelChSiSt" :on-success="handleSuccessChangeExcelChSiSt" :auto-upload="true" :show-file-list="false">
              <span>SI清单模板(中文)</span>
              <el-input v-model="ruleForm.statementTemplateSiExcelCn" auto-complete="off" disabled style="width: 150px;margin-left:5px;">
              </el-input>
              <el-button size="mini" type="primary">上传</el-button>
            </el-upload>
            <el-button size="mini" type="danger" @click="removtePdf('statementTemplateSiExcelCn')">删除</el-button>
            <div class="el-upload__tip_pdf">格式：<span style="color:#F56C6C">EXCEL</span>&nbsp;&nbsp;&nbsp;&nbsp;大小：3MB</div>
          </el-form-item>
        </el-col>
        <el-col class="elementWidth">
          <el-form-item label=" " label-width="12px">
            <el-upload class="el-form-item__content3 inline-block-padf" :action="actionPath" :accept="acceptExcel" :data="uptoken" :before-upload="beforeAvatarUploadExcelEnSiSt" :on-remove="handleRemoveChangeExcelEnSiSt" :on-success="handleSuccessChangeExcelEnSiSt" :auto-upload="true" :show-file-list="false">
              <span>SI清单模板(英文)</span>
              <el-input v-model="ruleForm.statementTemplateSiExcelEn" auto-complete="off" disabled style="width: 160px;margin-left:5px;">
              </el-input>
              <el-button size="mini" type="primary">上传</el-button>
            </el-upload>
            <el-button size="mini" type="danger" @click="removtePdf('statementTemplateSiExcelEn')">删除</el-button>
            <div class="el-upload__tip_pdf">格式：<span style="color:#F56C6C">EXCEL</span>&nbsp;&nbsp;&nbsp;&nbsp;大小：3MB</div>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row v-show="inventoryTemplate">
        <el-col class="elementWidth">
          <el-form-item label=" " label-width="16px">
            <el-upload class="el-form-item__content3 inline-block-padf" :action="actionPath" :accept="acceptExcel" :data="uptoken" :before-upload="beforeAvatarUploadExcelChTeSt" :on-remove="handleRemoveChangeExcelChTeSt" :on-success="handleSuccessChangeExcelChTeSt" :auto-upload="true" :show-file-list="false">
              <span>TE清单模板(中文)</span>
              <el-input v-model="ruleForm.statementTemplateTeExcelCn" auto-complete="off" disabled style="width: 150px;">
              </el-input>
              <el-button size="mini" type="primary">上传</el-button>
            </el-upload>
            <el-button size="mini" type="danger" @click="removtePdf('statementTemplateTeExcelCn')">删除</el-button>
            <div class="el-upload__tip_pdf">格式：<span style="color:#F56C6C">EXCEL</span>&nbsp;&nbsp;&nbsp;&nbsp;大小：3MB</div>
          </el-form-item>
        </el-col>
        <el-col class="elementWidth">
          <el-form-item label=" " label-width="12px">
            <el-upload class="el-form-item__content3 inline-block-padf" :action="actionPath" :accept="acceptExcel" :data="uptoken" :before-upload="beforeAvatarUploadExcelEnTeSt" :on-remove="handleRemoveChangeExcelEnTeSt" :on-success="handleSuccessChangeExcelEnTeSt" :auto-upload="true" :show-file-list="false">
              <span>TE清单模板(英文)</span>
              <el-input v-model="ruleForm.statementTemplateTeExcelEn" auto-complete="off" disabled style="width: 160px;">
              </el-input>
              <el-button size="mini" type="primary">上传</el-button>
            </el-upload>
            <el-button size="mini" type="danger" @click="removtePdf('statementTemplateTeExcelEn')">删除</el-button>
            <div class="el-upload__tip_pdf">格式：<span style="color:#F56C6C">EXCEL</span>&nbsp;&nbsp;&nbsp;&nbsp;大小：3MB</div>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row v-show="inventoryTemplate">
        <el-col class="elementWidth">
          <el-form-item label=" " label-width="16px">
            <el-upload class="el-form-item__content3 inline-block-padf" :action="actionPath" :accept="acceptExcel" :data="uptoken" :before-upload="beforeAvatarUploadExcelChTiSt" :on-remove="handleRemoveChangeExcelChTiSt" :on-success="handleSuccessChangeExcelChTiSt" :auto-upload="true" :show-file-list="false">
              <span>TI清单模板(中文)</span>
              <el-input v-model="ruleForm.statementTemplateTiExcelCn" auto-complete="off" disabled style="width: 150px;margin-left:5px;">
              </el-input>
              <el-button size="mini" type="primary">上传</el-button>
            </el-upload>
            <el-button size="mini" type="danger" @click="removtePdf('statementTemplateTiExcelCn')">删除</el-button>
            <div class="el-upload__tip_pdf">格式：<span style="color:#F56C6C">EXCEL</span>&nbsp;&nbsp;&nbsp;&nbsp;大小：3MB</div>
          </el-form-item>
        </el-col>
        <el-col class="elementWidth">
          <el-form-item label=" " label-width="12px">
            <el-upload class="el-form-item__content3 inline-block-padf" :action="actionPath" :accept="acceptExcel" :data="uptoken" :before-upload="beforeAvatarUploadExcelEnTiSt" :on-remove="handleRemoveChangeExcelEnTiSt" :on-success="handleSuccessChangeExcelEnTiSt" :auto-upload="true" :show-file-list="false">
              <span>TI清单模板(英文)</span>
              <el-input v-model="ruleForm.statementTemplateTiExcelEn" auto-complete="off" disabled style="width: 160px;margin-left:5px;">
              </el-input>
              <el-button size="mini" type="primary">上传</el-button>
            </el-upload>
            <el-button size="mini" type="danger" @click="removtePdf('statementTemplateTiExcelEn')">删除</el-button>
            <div class="el-upload__tip_pdf">格式：<span style="color:#F56C6C">EXCEL</span>&nbsp;&nbsp;&nbsp;&nbsp;大小：3MB</div>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row v-show="inventoryTemplate">
        <el-col class="elementWidth">
          <el-form-item label=" " label-width="16px">
            <el-upload class="el-form-item__content3 inline-block-padf" :action="actionPath" :accept="acceptExcel" :data="uptoken" :before-upload="beforeAvatarUploadExcelChLcSt" :on-remove="handleRemoveChangeExcelChLcSt" :on-success="handleSuccessChangeExcelChLcSt" :auto-upload="true" :show-file-list="false">
              <span>LC清单模板(中文)</span>
              <el-input v-model="ruleForm.statementTemplateLcExcelCn" auto-complete="off" disabled style="width: 150px;">
              </el-input>
              <el-button size="mini" type="primary">上传</el-button>
            </el-upload>
            <el-button size="mini" type="danger" @click="removtePdf('statementTemplateLcExcelCn')">删除</el-button>
            <div class="el-upload__tip_pdf">格式：<span style="color:#F56C6C">EXCEL</span>&nbsp;&nbsp;&nbsp;&nbsp;大小：3MB</div>
          </el-form-item>
        </el-col>
        <el-col class="elementWidth">
          <el-form-item label=" " label-width="12px">
            <el-upload class="el-form-item__content3 inline-block-padf" :action="actionPath" :accept="acceptExcel" :data="uptoken" :before-upload="beforeAvatarUploadExcelEnLcSt" :on-remove="handleRemoveChangeExcelEnLcSt" :on-success="handleSuccessChangeExcelEnLcSt" :auto-upload="true" :show-file-list="false">
              <span>LC清单模板(英文)</span>
              <el-input v-model="ruleForm.statementTemplateLcExcelEn" auto-complete="off" disabled style="width: 160px;">
              </el-input>
              <el-button size="mini" type="primary">上传</el-button>
            </el-upload>
            <el-button size="mini" type="danger" @click="removtePdf('statementTemplateLcExcelEn')">删除</el-button>
            <div class="el-upload__tip_pdf">格式：<span style="color:#F56C6C">EXCEL</span>&nbsp;&nbsp;&nbsp;&nbsp;大小：3MB</div>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row v-show="inventoryTemplate">
        <el-col class="elementWidth">
          <el-form-item label=" " label-width="16px">
            <el-upload class="el-form-item__content3 inline-block-padf" :action="actionPath" :accept="acceptExcel" :data="uptoken" :before-upload="beforeAvatarUploadExcelChIoSt" :on-remove="handleRemoveChangeExcelChIoSt" :on-success="handleSuccessChangeExcelChIoSt" :auto-upload="true" :show-file-list="false">
              <span>IO清单模板(中文)</span>
              <el-input v-model="ruleForm.statementTemplateIoExcelCn" auto-complete="off" disabled style="width: 150px;margin-left:5px;">
              </el-input>
              <el-button size="mini" type="primary">上传</el-button>
            </el-upload>
            <el-button size="mini" type="danger" @click="removtePdf('statementTemplateIoExcelCn')">删除</el-button>
            <div class="el-upload__tip_pdf">格式：<span style="color:#F56C6C">EXCEL</span>&nbsp;&nbsp;&nbsp;&nbsp;大小：3MB</div>
          </el-form-item>
        </el-col>
        <el-col class="elementWidth">
          <el-form-item label=" " label-width="12px">
            <el-upload class="el-form-item__content3 inline-block-padf" :action="actionPath" :accept="acceptExcel" :data="uptoken" :before-upload="beforeAvatarUploadExcelEnIoSt" :on-remove="handleRemoveChangeExcelEnIoSt" :on-success="handleSuccessChangeExcelEnIoSt" :auto-upload="true" :show-file-list="false">
              <span>IO清单模板(英文)</span>
              <el-input v-model="ruleForm.statementTemplateIoExcelEn" auto-complete="off" disabled style="width: 160px;">
              </el-input>
              <el-button size="mini" type="primary">上传</el-button>
            </el-upload>
            <el-button size="mini" type="danger" @click="removtePdf('statementTemplateIoExcelEn')">删除</el-button>
            <div class="el-upload__tip_pdf">格式：<span style="color:#F56C6C">EXCEL</span>&nbsp;&nbsp;&nbsp;&nbsp;大小：3MB</div>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row>
				<el-form-item style="margin-left: 15px;">
					...
					<el-button size="small" class="el_button_org" @click="resetPassward">重置密码</el-button>
				</el-form-item>
			</el-row>
		</el-form>
...
<script>
	export default {
		...
		data() {
          ...
          updateDeptNameFlag: '',
				...
				// accept3: ".doc,.docx,.xls,.xlsx,.ppt,.pptx,.pdf,.zip,.rar",
				accept3: ".pdf",
		...
		inject: ['queryList'],
		created: function() {
			if (this.frow.orgType == 2) {
				this.titleTop = "签约用户 - 修改";
				this.orgFlag = false;
				this.ruleForm.coopId = "签约用户";
			} else {
				this.titleTop = "签约公司 - 修改";
			}
			let that = this;
        ...
        that.ruleForm.orgNameOld = that.ruleForm.orgName;//保存初始的签约公司名称，以判断签约公司名称是否有变化
				that.ruleForm.orgStatus = that.ruleForm.orgStatus + '';
				that.ruleForm.stopDate = that.ruleForm.stopDate.replace("00:00:00", "23:59:59")
			...
			if (this.frow.adminId) {
				this.$axios.get('/hrs/user/' + this.frow.adminId).then(function(response) {
					that.user.data = response.data.data;
					that.user.data.passWord = '';
				}).catch(function(error) {
					console.log(error);
				});
			}
			...
			this.$axios.get('/hrs/org/listCategory/国际电话区号')
				.then(function(response) {
					...
					if (!this.frow.adminInternationalCountryCode) {
						this.ruleForm.adminInternationalCountryCode = this.internationalCountryCodes[0].edicode1;
					} else {
						this.ruleForm.adminInternationalCountryCode = this.frow.adminInternationalCountryCode;
					}
				}.bind(this));
		...
		mounted: function() {
      this.$axios.post('/prm/coop/queryListForChooseForUpdate/' + this.frow.orgId)
				.then(function(response) {
			...
			//
			if (this.frow.orgLogo != null && this.frow.orgLogo != '') {
				let filelists = [];
				let item = {
					name: this.frow.orgLogo.substring(this.frow.orgLogo.lastIndexOf("\/") + 1),
					url: this.frow.orgLogo
				}
				filelists.push(item);
				this.formData.smallModelPhoto = filelists;
			}
			//
			if (this.frow.shortLogo != null && this.frow.shortLogo != '') {
				let filelists2 = [];
				let item2 = {
					name: this.frow.shortLogo.substring(this.frow.shortLogo.lastIndexOf("\/") + 1),
					url: this.frow.shortLogo
				}
				filelists2.push(item2);
				this.formData2.smallModelPhoto = filelists2;
			}

			if (this.frow.orgSeal != null && this.frow.orgSeal != '') {
				this.orgSealUploadFileList.push({
					name: this.frow.orgSeal.substring(this.frow.orgSeal.lastIndexOf("\/") + 1),
					url: this.frow.orgSeal
				})
			}
			//
			//      if (this.frow.chBillTemplate) {
			//      	var filelists3 = [];
			//       var item3 = {
			//         name: this.frow.chBillTemplate.substring(this.frow.chBillTemplate.lastIndexOf("\/")+1),
			//         url: this.frow.chBillTemplate
			// }
			//       filelists3.push(item3);
			//       this.formData3.smallModelPhoto = filelists3;
			//      }
			//      //
			//      if (this.frow.enBillTemplate) {
			//      	var filelists4 = [];
			//       var item4 = {
			//         name: this.frow.enBillTemplate.substring(this.frow.enBillTemplate.lastIndexOf("\/")+1),
			//         url: this.frow.enBillTemplate
			// }
			//       filelists4.push(item4);
			//       this.formData4.smallModelPhoto = filelists4;
			//      }
			//      //
			//      if (this.frow.chListTemplate) {
			//      	var filelists5 = [];
			//       var item5 = {
			//         name: this.frow.chListTemplate.substring(this.frow.chListTemplate.lastIndexOf("\/")+1),
			//         url: this.frow.chListTemplate
			// }
			//       filelists5.push(item5);
			//       this.formData5.smallModelPhoto = filelists5;
			//      }
			//      //
			//      if (this.frow.enListTemplate) {
			//      	var filelists6 = [];
			//       var item6 = {
			//         name: this.frow.enListTemplate.substring(this.frow.enListTemplate.lastIndexOf("\/")+1),
			//         url: this.frow.enListTemplate
			// }
			//       filelists6.push(item6);
			//       this.formData6.smallModelPhoto = filelists6;
			//      }
        ...
        if (fileSealCheck.test(file.name)) {
          this.openError("上传LOGO(大)名称中不能带有中文及空格");
          return false
        }
        this.uptoken.key = this.buildAttachmentUploadFileKey(file, "logo", 400, 100);
        let _this = this
        ...
        let fileSealCheck = /[\u4e00-\u9fa5\s+]+/g;
        if (fileSealCheck.test(file.name)) {
          this.openError("上传LOGO(小)名称中不能带有中文及空格");
          return false
        }
        this.uptoken.key = this.buildAttachmentUploadFileKey(file, "logo", 100, 100);
        let _this = this
        const isSize = new Promise(function (resolve, reject) {
          let width = 100;
          let height = 100;
    ...
    handleSuccessChangeExcelEnTe(response, file, fileList) { //上传成功后在图片框显示图片
      ...
      handleSuccessChangeExcelEnLc(response, file, fileList) { //上传成功后在图片框显示图片
        ...
        this.uptoken.key = this.buildAttachmentUploadFileKey(file, "seal", 300, 300);
        let _this = this
        const isSize = new Promise(function (resolve, reject) {
          let width = 300;
          let height = 300;
          ...
          img.onload = function () {
			...
			submitForm(formName) {
				...
				if (this.frow.orgType == 2) {
					if (this.ruleForm.coopId != "签约用户") {
						this.$confirm('是否确认将 签约用户 转为 签约公司？', '提示', {
							confirmButtonText: '确定',
							cancelButtonText: '取消',
							type: 'warning',
							center: true
						}).then(() => {
							if (!this.ruleForm.demandPersonId) {
								this.openError2("签约用户转签约公司需求人不能为空");
							} else {
								this.ruleForm.orgType = 1;
                this.ruleForm.updateDeptNameFlag = 'need';
								this.surePost(formName);
							}
						}).catch(() => {
							this.ruleForm.orgCode = this.frow.orgCode;
							this.ruleForm.orgName = this.frow.orgName;
							this.ruleForm.coopId = "签约用户";
							this.surePost(formName);
						});
					} else {
          ...
          if(this.ruleForm.orgNameOld !== this.ruleForm.orgName){
              this.ruleForm.updateDeptNameFlag = 'need';
          }else{
              this.ruleForm.updateDeptNameFlag = 'unNeed';
          }
					this.surePost(formName);
				}
			...
			surePost(formName) {
				this.$refs[formName].validate((valid) => {
					if (valid) {
						...
						if (this.ruleForm.coopId === '签约用户') {
							this.ruleForm.coopId = "";
							this.ruleForm.coopName = "";
						}
			...
			removtePdf(s) {
				if (s == "chBillTemplate") {
					this.ruleForm.chBillTemplate = "";
				} else if (s == "enBillTemplate") {
					this.ruleForm.enBillTemplate = "";
				} else if (s == "enBillTemplateAi") {
					this.ruleForm.enBillTemplateAi = "";
				} else if (s == "chBillTemplateAi") {
					this.ruleForm.chBillTemplateAi = "";
				} else if (s == "enBillTemplateSe") {
					this.ruleForm.enBillTemplateSe = "";
				} else if (s == "chBillTemplateSe") {
					this.ruleForm.chBillTemplateSe = "";
				} else if (s == "enBillTemplateSi") {
					this.ruleForm.enBillTemplateSi = "";
				} else if (s == "chBillTemplateSi") {
					this.ruleForm.chBillTemplateSi = "";
				} else if (s == "enBillTemplateTe") {
					this.ruleForm.enBillTemplateTe = "";
				} else if (s == "chBillTemplateTe") {
					this.ruleForm.chBillTemplateTe = "";
				} else if (s == "enBillTemplateTi") {
					this.ruleForm.enBillTemplateTi = "";
				} else if (s == "chBillTemplateTi") {
					this.ruleForm.chBillTemplateTi = "";
				} else if (s == "chBillTemplateLc"){
          this.ruleForm.chBillTemplateLc = "";
        } else if (s == "enBillTemplateLc"){
          this.ruleForm.enBillTemplateLc = "";
        } else if (s == "chBillTemplateIo"){
          this.ruleForm.chBillTemplateIo = "";
        } else if (s == "enBillTemplateIo"){
          this.ruleForm.enBillTemplateIo = "";
        } else if (s == "chBillTemplateExcel") {
        	this.ruleForm.chBillTemplateExcel = "";
        } else if (s == "enBillTemplateExcel") {
        	this.ruleForm.enBillTemplateExcel = "";
        } else if (s == "enBillTemplateAiExcel") {
        	this.ruleForm.enBillTemplateAiExcel = "";
        } else if (s == "chBillTemplateAiExcel") {
        	this.ruleForm.chBillTemplateAiExcel = "";
        } else if (s == "enBillTemplateSeExcel") {
        	this.ruleForm.enBillTemplateSeExcel = "";
        } else if (s == "chBillTemplateSeExcel") {
        	this.ruleForm.chBillTemplateSeExcel = "";
        } else if (s == "enBillTemplateSiExcel") {
        	this.ruleForm.enBillTemplateSiExcel = "";
        } else if (s == "chBillTemplateSiExcel") {
        	this.ruleForm.chBillTemplateSiExcel = "";
        } else if (s == "enBillTemplateTeExcel") {
        	this.ruleForm.enBillTemplateTeExcel = "";
        } else if (s == "chBillTemplateTeExcel") {
        	this.ruleForm.chBillTemplateTeExcel = "";
        } else if (s == "enBillTemplateTiExcel") {
        	this.ruleForm.enBillTemplateTiExcel = "";
        } else if (s == "chBillTemplateTiExcel") {
        	this.ruleForm.chBillTemplateTiExcel = "";
        } else if (s == "enBillTemplateLcExcel") {
            this.ruleForm.enBillTemplateLcExcel = "";
        } else if (s == "chBillTemplateLcExcel") {
            this.ruleForm.chBillTemplateLcExcel = "";
        } else if (s == "enBillTemplateIoExcel") {
            this.ruleForm.enBillTemplateIoExcel = "";
        } else if (s == "chBillTemplateIoExcel") {
            this.ruleForm.chBillTemplateIoExcel = "";
        } else if (s == "statementTemplateAeExcelCn") {
            this.ruleForm.statementTemplateAeExcelCn = "";
        } else if (s == "statementTemplateAeExcelEn") {
            this.ruleForm.statementTemplateAeExcelEn = "";
        } else if (s == "statementTemplateAiExcelCn") {
            this.ruleForm.statementTemplateAiExcelCn = "";
        } else if (s == "statementTemplateAiExcelEn") {
            this.ruleForm.statementTemplateAiExcelEn = "";
        } else if (s == "statementTemplateSeExcelCn") {
            this.ruleForm.statementTemplateSeExcelCn = "";
        } else if (s == "statementTemplateSeExcelEn") {
            this.ruleForm.statementTemplateSeExcelEn = "";
        } else if (s == "statementTemplateSiExcelCn") {
            this.ruleForm.statementTemplateSiExcelCn = "";
        } else if (s == "statementTemplateSiExcelEn") {
            this.ruleForm.statementTemplateSiExcelEn = "";
        } else if (s == "statementTemplateTeExcelCn") {
            this.ruleForm.statementTemplateTeExcelCn = "";
        } else if (s == "statementTemplateTeExcelEn") {
            this.ruleForm.statementTemplateTeExcelEn = "";
        } else if (s == "statementTemplateTiExcelCn") {
            this.ruleForm.statementTemplateTiExcelCn = "";
        } else if (s == "statementTemplateTiExcelEn") {
            this.ruleForm.statementTemplateTiExcelEn = "";
        } else if (s == "statementTemplateLcExcelCn") {
            this.ruleForm.statementTemplateLcExcelCn = "";
        } else if (s == "statementTemplateLcExcelEn") {
            this.ruleForm.statementTemplateLcExcelEn = "";
        } else if (s == "statementTemplateIoExcelCn") {
            this.ruleForm.statementTemplateIoExcelCn = "";
        } else if (s == "statementTemplateIoExcelEn") {
            this.ruleForm.statementTemplateIoExcelEn = "";
        }
				return false;
			},
      ...
      buildAttachmentUploadFileKey(file, business, width, height) {
        let orgUuid = localStorage.getItem("orgUuid");
        return "org/config/" + orgUuid + "/" + business + "_" + width + "_" + height + "_" + new Date().format("yyMMddhhmmss") + file.name.substring(file.name.lastIndexOf('.'));
      }
    }
	}
</script>
