<template>
  <el-dialog title="回收 - 权限" width="75%" :visible.sync="visible" :close-on-press-escape="false" :close-on-click-modal="false" :before-close="handleClose">
    <div class="warp-main hrs-permission-recycle">
            ...
            <el-row>
              ...
              <el-col class="elementWidth">
                <el-form-item style="margin-left: 41px; margin-top: -6px">
                  ...
                  <el-button type="primary" size="small" @click="confirmRecycle">回收确认</el-button>
                </el-form-item>
              </el-col>
            </el-row>
          </el-form>
    ...
    export default {
      ...
      methods: {
        ...
        findByPage(){
          ...
          this.$axios.get2('/hrs/org-permission/eqOrg', param)
        ...
        confirmRecycle(){
          ...
          let message = '是否确认回收 “'+this.frow['name']+'”权限？';
          this.$confirm(message, '注意', {
            ...
            this.$axios.post2("/hrs/org-permission/remove/"+this.query.permissionId, this.selectionIds)
              .then(function (response) {
                if(response.data.code == 0){
                  this.stopLoading();
                  this.openSuccess();
