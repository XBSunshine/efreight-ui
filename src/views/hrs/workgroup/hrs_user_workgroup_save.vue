<template>
  ...
  <el-dialog  title="工作组 - 新增" width="800px" :visible.sync="visible" :close-on-press-escape="false" :close-on-click-modal="false" :before-close="handleClose" append-to-body>
        ...
        saveWorkgroup(){
          this.$refs['ruleForm'].validate((valid) => {
            if (valid) {
              ...
              this.$axios.post2("/hrs/userWorkgroup/save", this.ruleForm)
