<template>
	<el-dialog title="版本管理 - 版本更新记录 - 新增" width="600px" :visible.sync="visible" :close-on-press-escape="false" :close-on-click-modal="false" :before-close="handleClose" append-to-body>
		<el-row>
			<el-form :model="form" ref="form" class="demo-ruleForm version-record-save">
				<el-row>
		...
		methods: {
			...
			submitForm() {
				if(this.form.versionId == '') {
					...
					this.$axios.post2('/hrs/version/child', this.form)
