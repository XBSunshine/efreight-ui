<template>
	<el-dialog title="用户管理——兼职部门" width="75%" :visible.sync="visible" :close-on-press-escape="false" :close-on-click-modal="false" :before-close="handleClose" append-to-body>
		<el-row>
			<el-form :model="form" ref="form" label-width="140px" class="demo-ruleForm">
				<el-row>
					...
					<el-col :span="11">
						<el-form-item label="所属部门" prop="deptId" :rules="[{ required: true, message: '部门不能为空',trigger:'blur'}]">
				...
				<el-row>
					<el-col :span="11">
						<el-form-item label="岗位" prop="jobPosition" :rules="[{ required: true, message: '岗位不能为空',trigger:'blur'}]">
		...
		<el-table :data="data">
			...
			<el-table-column prop="isMain" label="是否主部门" :formatter="formatIsMain"></el-table-column>
			<el-table-column prop="deptStatus" label="状态" :formatter="formatDeptStatus"></el-table-column>
