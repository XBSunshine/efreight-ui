<template>
	<el-dialog :title="name+' - 选择'" width="1150px" :visible.sync="visible" :close-on-press-escape="false" :close-on-click-modal="false" :before-close="handleClose" append-to-body style="top:-80px;">
...
<script>
	export default {
		...
		inject: ['setShipperConsigneeValue2'],
		created: function() {
			...
			var a = JSON.stringify(this.frow.rowBean);
			this.ruleForm = JSON.parse(a);
			this.ruleForm.scType = this.frow.scType;
      ...
      searchNationalName(){
        ...
        this.searchNationalName();
			...
			doFinish(rrow) {
				this.setShipperConsigneeValue2(this.ruleForm);
				this.handleClose();
			},
			doClean() {
				this.ruleForm = {
        ...
        let result1 = '', tel = (this.ruleForm.telNumber || ""), fax = (this.ruleForm.faxNumber || "");
