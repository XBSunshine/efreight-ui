          ...
          <el-form-item label="附件名称" prop="fileName" required label-width="115px">
				...
				<el-col class="elementWidth">
					...
					<el-form-item label-width="1px">
						<el-upload :action="actionPath" :accept="accept3" :show-file-list="false" :data="uptoken" :before-upload="beforeAvatarUpload3" :on-remove="handleRemoveChange3" :on-success="handleSuccessChange3" ref="upload3" :auto-upload="true">
							<el-button type="primary" size="mini" @click="clickSelect" >选择</el-button>
						</el-upload>
					</el-form-item>
				</el-col>
			</el-row>
			...
			<el-row>
				<el-form-item style="margin-left: 15px;">
					<el-button :loading="loading"  type="primary" @click="submitForm1('ruleForm')">保存</el-button>
				</el-form-item>
			</el-row>
		</el-form>
	</el-dialog>
	...
	export default {
        ...
        return isLt10M;
            ...
            let p={
               ...
               fileRemark: this.ruleForm.fileRemark,
            }
           this.ps = [];
           this.ps.push(p);
           let ruleForm2={
                fileStrs:JSON.stringify(this.ps),
