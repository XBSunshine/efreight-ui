	...
	<div class="warp-main">
		<el-row class="css_P_form">
							...
							<el-col class="elementWidth">
								<el-form-item label-width="10px">
									<el-input v-model="query.departureStation" @input="query.departureStation=toUpperCaseValue(query.departureStation)" clearable auto-complete="off" style="width:189px;" maxlength="4" show-word-limit>
										...
										<template v-if="query.businessScope=='TE'||query.businessScope=='IO' || query.businessScope=='TI'" slot="prepend">起&nbsp;&nbsp;运&nbsp;&thinsp;地</template>
            ...
            <el-row v-show="showFlag">
              ...
              <el-col class="elementWidth" v-if="query.businessScope=='AE'">
                <el-form-item label-width="10px">
                  <el-input v-model="query.awbFromName" clearable auto-complete="off" style="width:350px;" maxlength="50" show-word-limit>
                  </el-input>
                </el-form-item>
              </el-col>
              ...
              <el-col class="elementWidth" v-if="checkJtFlag">
              	<el-form-item label-width="10px">
              		<el-input style="width:454px;">
              			...
              			<el-select slot="suffix" v-model="query.otherOrg" filterable placeholder="请选择" clearable style="width: 386px;margin-right: -5px">
...
<script>
	import setVisibleVue from './css_p_r_eport_settle_af/column_setting'
  ...
  import viewVisibleVueTI from '../tc/ti/order/main/order_view.vue'
	...
	import columns from './css_p_r_eport_settle_af/css_p_r_eport_settle_af_column.json'
	...
	export default {
      ...
      if(a&&a=='/jt_css_p_r_eport_settle_af'){
        let param ={
           checkJt:'jt'
        }
        //分公司集合
        ...
        if (row.businessScope === 'TI') {
			...
			businessScopeChange() {
				...
				if (this.query.businessScope == 'AE' || this.query.businessScope == 'SE') {
					...
					if (this.query.businessScope == 'SI' || this.query.businessScope == 'AI') {
