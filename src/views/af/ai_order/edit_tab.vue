<template>
	...
	<div class="orderEditPage">
			...
			<el-row>
				...
				<el-col class="elementWidth">
					<el-form-item label="" prop="coopName">
						<el-input v-model="ruleForm.coopName" style="width:623px;margin-right: 15px;" readOnly class="widthWithFive" :disabled="!viewFlag">
							<template slot="prepend"><b style="color:red">*</b>客户名称</template>
							<el-button slot="append" icon="el-icon-search" @click="gotoSelectPage('ruleForm')" :disabled="!viewFlag"></el-button>
						</el-input>
				...
				<el-col class="elementWidth">
					<el-form-item label="" prop="salesId">
						<el-input style="width:227px;">
							...
							<el-select slot="suffix" v-model="ruleForm.salesId" filterable placeholder="请选择" @change="setSalesName" style="width:130px;margin-right: -5px;" :disabled="!viewFlag">
        ...
        <el-col class="elementWidth">
          <el-form-item prop="servicerId">
            <el-input style="width:80px;">
              ...
              <el-select slot="suffix" v-model="ruleForm.servicerId" filterable placeholder="请选择" @change="setServicerName" style="width:102px;margin-right: -5px;" :disabled="!viewFlag">
                <el-option v-for="item in useroptions" :key="item.value" :label="item.label" :value="item.value">
                  <span style="float: left">{{ item.label }}</span>
                  <span style="float: right; color: #8492a6; font-size: 13px">{{ item.label2 }}</span>
                </el-option>
			...
			<el-row>
				<el-col class="elementWidth">
					<el-form-item label="" prop="customerNumber">
						<el-input v-model="ruleForm.customerNumber" @input="ruleForm.customerNumber=ruleForm.customerNumber.toUpperCase()" auto-complete="off" maxlength="40" style="width:240px;margin-right: 15px;" :disabled="!viewFlag" clearable>
				...
				<el-col class="elementWidth">
					<el-form-item label="" prop="awbNumber">
						<el-input class="widthWithThreeWithXing" v-model="ruleForm.awbNumber" auto-complete="off" maxlength="12" @input="formatToFloat('awbNumber')" style="width:299px;margin-right: 15px;" :disabled="!viewFlag" clearable>
				...
				<el-col class="elementWidth">
					<el-form-item label="" prop="hawbNumber">
						<el-input class="widthWithThree" v-model="ruleForm.hawbNumber" @input="ruleForm.hawbNumber=ruleForm.hawbNumber.toUpperCase()" auto-complete="off" maxlength="40" style="width:299px;margin-right: 15px;" :disabled="!viewFlag" clearable>
        ...
        <el-col class="elementWidth">
          <el-form-item>
            <el-input class="widthWorkGroup" auto-complete="off" style="width:338px;" :disabled="!viewFlag" clearable>
              <template slot="prepend">
                <span>工作组</span>
              </template>
				...
				<!--<el-col class="elementWidth">
					<el-form-item label="" prop="servicerId">
						<el-input style="width:340px;">
							...
							<el-select slot="suffix" v-model="ruleForm.servicerId" filterable placeholder="请选择" @change="setServicerName" style="width:243px;margin-right: -5px;" :disabled="!viewFlag">
								<el-option v-for="item in useroptions" :key="item.value" :label="item.label" :value="item.value">
									<span style="float: left">{{ item.label }}</span>
									<span style="float: right; color: #8492a6; font-size: 13px">{{ item.label2 }}</span>
								</el-option>
        ...
        <el-col class="elementWidth">
          <el-form-item prop="departureStation">
            <el-input class="widthWithThree" style="width: 240px;margin-right: 15px;">
              ...
              <el-select slot="suffix"  clearable  remote :filter-method="searchAirport" filterable v-model="ruleForm.departureStation"
                         @input="ruleForm.departureStation = ruleForm.departureStation.toUpperCase()"
                         @keydown.native="keydownEvent"
                         placeholder="请输入关键词" style="width:143px;margin-right: -5px;" :disabled="!viewFlag">
        ...
        <el-col class="elementWidth">
          <el-form-item prop="arrivalStation">
            <el-input class="widthWithThree"  style="width: 299px;margin-right: 15px;">
              ...
              <el-select slot="suffix" remote :filter-method="searchAirport" filterable v-model="ruleForm.arrivalStation"
                         @input="ruleForm.arrivalStation = ruleForm.arrivalStation.toUpperCase()"
                         @keydown.native="currentSelectKey='arrivalStation'"
                         placeholder="请输入关键词" style="width:204px;margin-right: -5px;" :disabled="!viewFlag">
                <el-option v-for="item in airportList" :key="item.apCode" :value="item.apCode">
                  <el-row>
                    <el-col :span="2" style="width: unset;margin-right: 10px">{{item.apCode}}</el-col>
                    <el-col :span="10" style="overflow-x: hidden; width: unset; margin-right: 10px">{{item.apNameEn}}</el-col>
				...
				<el-col class="elementWidth">
					<el-form-item label="" prop="expectFlight">
						<el-input class="widthWithThree" v-model="ruleForm.expectFlight" @change="ruleForm.expectFlight=strTrim(ruleForm.expectFlight).toUpperCase()" maxlength="10" style="width:299px;margin-right: 15px;" :disabled="!viewFlag" clearable>
				...
				<el-col class="elementWidth">
					<el-form-item label="" prop="expectArrival">
						<el-input style="width:340px;">
							...
							<el-date-picker slot="suffix" v-model="ruleForm.expectArrival" type="date" value-format="yyyy-MM-dd" placeholder="选择日期" style="width: 243px; margin-right:-5px" :disabled="!viewFlag">
							</el-date-picker>
						</el-input>
					</el-form-item>
				</el-col>
			...
			<el-row>
				<el-col class="elementWidth">
					<el-form-item label="" prop="planPieces">
						<el-input v-model="ruleForm.planPieces" @change="ruleForm.planPieces=strTrim(ruleForm.planPieces)" @input="formatToFloat('planPieces')" auto-complete="off" style="width:240px;margin-right: 15px;" :disabled="!viewFlag" clearable maxlength="10">
							<template slot="prepend">分单件数</template>

							<el-select slot="append" v-model="ruleForm.packageType" filterable placeholder="请选择" style="width:75px" :disabled="!viewFlag">
				...
				<el-col class="elementWidth">
					<el-form-item label="" prop="planWeight">
						<el-input v-model="ruleForm.planWeight" @change="formatDecimalPlaces('planWeight')" @input="formatToFloat('planWeight')" auto-complete="off" style="width:299px;margin-right: 15px;" :disabled="!viewFlag" clearable>
				...
				<el-col class="elementWidth">
					<el-form-item label="" prop="planVolume">
						<el-input v-model="ruleForm.planVolume" @change="formatDecimalPlaces('planVolume')" @input="formatToFloat('planVolume')" auto-complete="off" style="width:299px;margin-right: 15px;" :disabled="!viewFlag" clearable>
				...
				<el-col class="elementWidth">
					<el-form-item label="" prop="planChargeWeight">
						<el-input class="widthWithFive2" v-model="ruleForm.planChargeWeight" @change="formatDecimalPlaces('planChargeWeight')" @input="formatToFloat('planChargeWeight')" auto-complete="off" style="width:340px" :disabled="!viewFlag" clearable>
			...
			<el-row>
				<el-col class="elementWidth">
					<el-form-item label="" prop="orderRemark">
						<el-input class="showWordLimit" v-model="ruleForm.orderRemark" @change="ruleForm.orderRemark=strTrim(ruleForm.orderRemark)" auto-complete="off" style="width:1254px" :disabled="!viewFlag" show-word-limit maxlength="200" clearable>
			...
			<div style="padding:0px 0px 0px 30px">
				...
				<el-row v-show="showFlagConAndShipper">
					<el-col class="elementWidth" style="margin-left: 50px;">
						<el-row>
							...
							<el-button @click="gotoShipperConsigneePage(0)" icon="el-icon-edit" type="text" :disabled="!viewFlag">编辑</el-button>
						</el-row>
						<el-row>
							<el-form-item>
					...
					<el-col class="elementWidth" style="margin-left: 50px;">
						<el-row>
							...
							<el-button @click="gotoShipperConsigneePage(1)" icon="el-icon-edit" type="text" :disabled="!viewFlag">编辑</el-button>
						</el-row>
						<el-row>
							<el-form-item>
				...
				<el-row v-show="showFlagConAndShipper">
					<el-col class="elementWidth" style="margin-left: 50px;">
						...
						<el-row>
							<el-form-item>
								<el-input type="textarea" show-word-limit maxlength="500" v-model="ruleForm.notifierRemark" @input="ruleForm.notifierRemark=ruleForm.notifierRemark.toUpperCase()" auto-complete="off" :rows="5" style="width:520px" :disabled="!viewFlag">
								</el-input>
							</el-form-item>
						</el-row>
					</el-col>
					<el-col class="elementWidth" style="margin-left: 50px;">
						...
						<el-row>
							<el-form-item>
								<el-input type="textarea" show-word-limit maxlength="500" v-model="ruleForm.departureAgent" @input="ruleForm.departureAgent=ruleForm.departureAgent.toUpperCase()" auto-complete="off" :rows="5" style="width:520px" :disabled="!viewFlag">
								</el-input>
							</el-form-item>
						</el-row>
					</el-col>
				...
				<el-row v-show="showFlag2">
					<el-col class="elementWidth" style="margin-left: 50px;">
						<el-form-item label="" prop="goodsType">
							<el-input style="width:300px;margin-right: 15px;">
								...
								<el-select slot="suffix" v-model="ruleForm.goodsType" filterable placeholder="请选择" style="width: 203px; margin-right:-5px" :disabled="!viewFlag">
					...
					<el-col class="elementWidth">
						<el-form-item label="" prop="goodsNameCn">
							<el-input class="showWordLimit" v-model="ruleForm.goodsNameCn" @change="ruleForm.goodsNameCn=strTrim(ruleForm.goodsNameCn).toUpperCase()" auto-complete="off" style="width:775px" :disabled="!viewFlag" show-word-limit maxlength="200" clearable>
				...
				<el-row v-show="showFlag2">
					<el-col class="elementWidth" style="margin-left: 50px;">
						<el-form-item label="" prop="cargoFlowType">
							<el-input style="width:300px;margin-right: 15px;">
								...
								<el-select slot="suffix" v-model="ruleForm.cargoFlowType" filterable placeholder="请选择" style="width:203px; margin-right:-5px" :disabled="!viewFlag">
					...
					<el-col class="elementWidth">
						<el-form-item label="" prop="cargoFlowRemark">
							<el-input class="showWordLimit" v-model="ruleForm.cargoFlowRemark" @change="ruleForm.cargoFlowRemark=strTrim(ruleForm.cargoFlowRemark)" auto-complete="off" style="width:775px" :disabled="!viewFlag" show-word-limit maxlength="200" clearable>
					...
					<el-tabs style="width: 1100px;height:280px;margin-left: 50px;" type="border-card" v-model="activeOperationName">
						<el-tab-pane name="first">
							<span slot="label" style="color: #909399;">
								<el-checkbox style="margin-right: 5px;" v-model="ruleForm.switchAwbService" @change="changeActiveOperationName('HD')" :disabled="!viewFlag"></el-checkbox>外库调单
							</span>
							<el-row>
								<el-col class="elementWidth">
									<el-form-item>
										<el-input style="width:300px;margin-right: 15px;">
											...
											<el-date-picker :disabled="!ruleForm.switchAwbService || !viewFlag" slot="suffix" v-model="ruleForm.switchAwbDate" clearable type="date" value-format="yyyy-MM-dd" placeholder="选择日期" style="width: 203px;margin-right: -5px;">
											</el-date-picker>
										</el-input>
									</el-form-item>
								</el-col>
								<el-col class="elementWidth">
									<el-form-item>
										<el-input class="showWordLimit" :disabled="!ruleForm.switchAwbService || !viewFlag" v-model="ruleForm.switchAwbAddress" auto-complete="off" style="width:730px;" show-word-limit maxlength="200" clearable>
											<template slot="prepend">
												<span>调单地址</span>
											</template>
										</el-input>
							...
							<el-row>
								<el-col class="elementWidth">
									<el-form-item>
										<el-input :disabled="!ruleForm.switchAwbService || !viewFlag" type="textarea" show-word-limit maxlength="500" v-model="ruleForm.switchAwbRemark" auto-complete="off" :rows="5" style="width: 1055px;">
										</el-input>
									</el-form-item>
								</el-col>
							</el-row>
						...
						<el-tab-pane name="second">
							<span slot="label" style="color: #909399;">
								<el-checkbox style="margin-right: 5px;" v-model="ruleForm.warehouseService" @change="changeActiveOperationName('KN')" :disabled="!viewFlag"></el-checkbox>库内操作
							</span>
							<el-row>
								<el-col class="elementWidth">
									<el-form-item>
										<el-input class="showWordLimit" :disabled="!ruleForm.warehouseService || !viewFlag" v-model="ruleForm.warehouseOperator" auto-complete="off" style="width:405px;margin-right: 15px;" show-word-limit maxlength="200" clearable>
											<template slot="prepend">
												<span>操作公司</span>
											</template>
										</el-input>
								...
								<el-col class="elementWidth">
									<el-form-item>
										<el-input style="width:300px;margin-right: 15px;">
											...
											<el-date-picker :disabled="!ruleForm.warehouseService || !viewFlag" slot="suffix" v-model="ruleForm.inboundDate" clearable type="date" value-format="yyyy-MM-dd" placeholder="选择入库日期" style="width: 203px;margin-right: -5px;">
											</el-date-picker>
										</el-input>
									</el-form-item>
								</el-col>
								<el-col class="elementWidth">
									<el-form-item>
										<el-input style="width:300px;">
											...
											<el-date-picker :disabled="!ruleForm.warehouseService || !viewFlag" slot="suffix" v-model="ruleForm.outboundDate" clearable type="date" value-format="yyyy-MM-dd" placeholder="选择出库日期" style="width: 203px;margin-right: -5px;">
											</el-date-picker>
										</el-input>
									</el-form-item>
								</el-col>
							...
							<el-row>
								<el-col class="elementWidth">
									<el-form-item>
										<el-input class="showWordLimit" :disabled="!ruleForm.warehouseService || !viewFlag" v-model="ruleForm.damageRemark" auto-complete="off" style="width:1055px;" show-word-limit maxlength="200" clearable>
											<template slot="prepend">
												<span>破损记录</span>
											</template>
										</el-input>
							...
							<el-row>
								<el-col class="elementWidth">
									<el-form-item>
										<el-input :disabled="!ruleForm.warehouseService || !viewFlag" type="textarea" show-word-limit maxlength="500" v-model="ruleForm.operationRemark" auto-complete="off" :rows="3" style="width: 1055px;">
										</el-input>
									</el-form-item>
								</el-col>
							</el-row>
						...
						<el-tab-pane name="third">
							<span slot="label" style="color: #909399;">
								<el-checkbox style="margin-right: 5px;" v-model="ruleForm.customsClearanceService" @change="changeActiveOperationName('BG')" :disabled="!viewFlag"></el-checkbox>报关服务
							</span>
							<el-row>
								<el-col class="elementWidth">
									<el-form-item>
										<el-input class="showWordLimit" :disabled="!ruleForm.customsClearanceService || !viewFlag" v-model="ruleForm.customsClearanceCompany" auto-complete="off" style="width:405px;margin-right: 15px;" show-word-limit maxlength="200" clearable>
											<template slot="prepend">
												<span>报关代理</span>
											</template>
										</el-input>
								...
								<el-col class="elementWidth">
									<el-form-item>
										<el-input style="width:300px;margin-right: 15px;">
											...
											<el-date-picker :disabled="!ruleForm.customsClearanceService || !viewFlag" slot="suffix" v-model="ruleForm.customsInspectionDate" clearable type="date" value-format="yyyy-MM-dd" placeholder="选择日期" style="width: 203px;margin-right: -5px;">
											</el-date-picker>
										</el-input>
									</el-form-item>
								</el-col>
								<el-col class="elementWidth">
									<el-form-item>
										<el-input style="width:300px;">
											...
											<el-date-picker :disabled="!ruleForm.customsClearanceService || !viewFlag" slot="suffix" v-model="ruleForm.customsClearanceDate" clearable type="date" value-format="yyyy-MM-dd" placeholder="选择放行日期" style="width: 203px;margin-right: -5px;">
											</el-date-picker>
										</el-input>
									</el-form-item>
								</el-col>
							...
							<el-row>
								<el-col class="elementWidth">
									<el-form-item>
										<el-input class="showWordLimit" :disabled="!ruleForm.customsClearanceService || !viewFlag" v-model="ruleForm.customsInspectionRemark" auto-complete="off" style="width:1055px;" show-word-limit maxlength="200" clearable>
											<template slot="prepend">
												<span>查验记录</span>
											</template>
										</el-input>
							...
							<el-row>
								<el-col class="elementWidth">
									<el-form-item>
										<el-input :disabled="!ruleForm.customsClearanceService || !viewFlag" type="textarea" show-word-limit maxlength="500" v-model="ruleForm.customsDeclaresRemark" auto-complete="off" :rows="3" style="width: 1055px;">
										</el-input>
									</el-form-item>
								</el-col>
							</el-row>
						...
						<el-tab-pane name="fourth">
							<span slot="label" style="color: #909399;">
								<el-checkbox style="margin-right: 5px;" v-model="ruleForm.deliveryService" @change="changeActiveOperationName('PS')" :disabled="!viewFlag"></el-checkbox>派送服务
							</span>
							<el-row>
								<el-col class="elementWidth">
									<el-form-item>
										<el-input class="showWordLimit" :disabled="!ruleForm.deliveryService || !viewFlag" v-model="ruleForm.deliveryCompany" auto-complete="off" style="width:300px;margin-right: 15px;" show-word-limit maxlength="200" clearable>
											<template slot="prepend">
												<span>卡车公司</span>
											</template>
										</el-input>
								...
								<el-col class="elementWidth">
									<el-form-item>
										<el-input :disabled="!ruleForm.deliveryService || !viewFlag" class="widthWithFourWithXG showWordLimit" v-model="ruleForm.deliveryDriver" @input="ruleForm.deliveryDriver=ruleForm.deliveryDriver.toUpperCase()" auto-complete="off" style="width:730px;" show-word-limit maxlength="200" clearable>
											<template slot="prepend">
												<span>车辆/司机</span>
											</template>
										</el-input>
							...
							<el-row>
								<el-col class="elementWidth">
									<el-form-item>
										<el-input :disabled="!ruleForm.deliveryService || !viewFlag" class="widthWithFive showWordLimit" v-model="ruleForm.deliverySigner" auto-complete="off" style="width:300px;margin-right: 15px;" show-word-limit maxlength="200" clearable>
											<template slot="prepend">
												<span>收货人信息</span>
											</template>
										</el-input>
								...
								<el-col class="elementWidth">
									<el-form-item>
										<el-input class="showWordLimit" :disabled="!ruleForm.deliveryService || !viewFlag" v-model="ruleForm.deliveryAddress" auto-complete="off" style="width:730px;" show-word-limit maxlength="200" clearable>
											<template slot="prepend">
												<span>送货地址</span>
											</template>
										</el-input>
										...
										<el-col class="elementWidth">
											<el-form-item>
												<el-input style="width:300px;">
													...
													<el-date-picker :disabled="!ruleForm.deliveryService || !viewFlag" slot="suffix" v-model="ruleForm.deliveryDate" clearable type="date" value-format="yyyy-MM-dd" placeholder="选择送货日期" style="width: 203px;margin-right: -5px;">
													</el-date-picker>
												</el-input>
											</el-form-item>
										</el-col>
										...
										<el-col class="elementWidth">
											<el-form-item>
												<el-input style="width:300px;">
													...
													<el-date-picker :disabled="!ruleForm.deliveryService || !viewFlag" slot="suffix" v-model="ruleForm.deliverySignDate" clearable type="date" value-format="yyyy-MM-dd" placeholder="选择签收日期" style="width: 203px;margin-right: -5px;">
													</el-date-picker>
												</el-input>
											</el-form-item>
										</el-col>
								...
								<el-col class="elementWidth">
									<div style="position: relative;left: 15px;top: -11px;">
										...
										<el-row>
											<el-col class="elementWidth">
												<el-form-item>
													<el-input :disabled="!ruleForm.deliveryService || !viewFlag" type="textarea" show-word-limit maxlength="500" v-model="ruleForm.deliveryRemark" auto-complete="off" :rows="3" style="width: 730px;">
													</el-input>
												</el-form-item>
											</el-col>
										</el-row>
			...
			<div style="padding:10px 0px 10px 0px" v-if="viewFlag">
				<HR color="#eee" size="5">
				</HR>
			</div>
			<el-row>
			...
			submitForm3(formName) {
				...
				this.$refs[formName].validate((valid) => {
					if (valid) {
						...
						this.$axios.post2('/afbase/aforder/doUpdateAI', this.ruleForm)
							.then(function(response) {
