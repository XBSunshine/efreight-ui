<template>
	<el-dialog title="" :fullscreen="ifFullscreen" width="1300px" :visible.sync="visible" :close-on-press-escape="false" :close-on-click-modal="false" :before-close="handleClose" :style="style" :show-close="!ifFullscreen" :append-to-body="ifFromInquiry">
		<div class="orderEditPage" style="width: 1280px;">
			<el-form :model="ruleForm" :rules="rules" :inline="true" ref="ruleForm" label-width="auto" class="demo-ruleForm" style="margin-left: 10px;">
				<div style="margin-top: -15px;margin-bottom: 20px;">
					<span style="font-size: large;margin-bottom: 20px;">空运操作订单 - 新增</span>
				...
				<el-row>
					...
					<el-col class="elementWidth">
						<el-form-item prop="coopName">
							<el-input v-model="ruleForm.coopName" style="width:615px;margin-right: 15px;">
				...
				<el-row>
					<el-col class="elementWidth">
						<el-form-item prop="departureStation">
							<el-input class="widthWithThreeWithXing" v-model="ruleForm.departureStation" clearable @change="sychronizeWareAndStore" auto-complete="off" maxlength="4" style="width: 295px;margin-right: 15px;" @input="ruleForm.departureStation=strTrim(ruleForm.departureStation).toUpperCase()">
								<template slot="prepend">
									<font style="color: red;">*</font>
									<span>始发港</span>
								</template>
					...
					<el-col class="elementWidth">
						<el-form-item prop="arrivalStation">
							<el-input class="widthWithThreeWithXing arrivalStationForAESave" v-model="ruleForm.arrivalStation" clearable @input="ruleForm.arrivalStation=strTrim(ruleForm.arrivalStation).toUpperCase()" auto-complete="off" maxlength="4" style="width: 295px;margin-right: 15px;"  >
								<template slot="prepend">
									<font style="color: red;">*</font>
									<span>目的港</span>
								</template>
				...
				<el-row>
					...
					<el-col class="elementWidth">
						<el-form-item prop="transitStation2">
							<el-input class="widthWithThreeWithXing" v-model="ruleForm.transitStation2" clearable @change="ruleForm.transitStation2=strTrim(ruleForm.transitStation2).toUpperCase()" auto-complete="off" maxlength="4" style="width: 295px;margin-right: 15px;">
								<template slot="prepend">
									<span>中转港2</span>
								</template>
							</el-input>
						...
						<el-col class="elementWidth">
							<el-form-item>
								<el-input auto-complete="off" style="width:200px;margin-right: 15px;">
									...
									<el-select slot="suffix" v-model="ruleForm.priceType" placeholder="请选择" style="width:103px;margin-right: -5px;" clearable>
						...
						<el-col class="elementWidth">
							<el-form-item>
								<el-input auto-complete="off" style="width:200px;margin-right: 15px;">
									...
									<el-select slot="suffix" v-model="ruleForm.priceType2" placeholder="请选择" style="width:103px;margin-right: -5px;" clearable>
										<el-option label="单价" value="单价"></el-option>
										<el-option label="总价" value="总价"></el-option>
									</el-select>
								</el-input>
				...
				<div style="padding:0px 0px 0px 30px">
					...
					<el-row v-show="showFlag2">
						...
						<el-col class="elementWidth">
							<el-form-item prop="appraisalNote">
								<el-input style="width:546px;" class="" @input="ruleForm.appraisalNote = ruleForm.appraisalNote.toUpperCase()" v-model="ruleForm.appraisalNote" auto-complete="off" clearable maxlength="32">
									<template slot="prepend">
										<span>鉴定号</span>
									</template>
								</el-input>
...
                ],
			...
			submitForm3(formName) {
				...
				this.$refs[formName].validate((valid) => {
					if (valid) {
						...
						this.$axios.post2('/afbase/afoporder/doSave', this.ruleForm)
							.then(function(response) {
		...
		created() {
			if (this.frow.ifFromInquiry) {
				...
				this.ruleForm.goodsType = this.frow.inquiry.goodsType
			...
			this.$axios.get('/afbase/awb/selectCategory?category=运输条款').then(function(response) {
				...
				//				this.ruleForm.transitClause = this.transitClauseOptions[0].value;
			}.bind(this));
			...
			this.$axios.get('/hrs/org/getOrgOrderConfig/AE').then((response) => {
				if (response.data.code == 0 && response.data.data) {
					...
					this.ruleForm.businessProduct = response.data.data.businessProduct
					...
					this.ruleForm.customsStatusCode = response.data.data.customsStatusCode
