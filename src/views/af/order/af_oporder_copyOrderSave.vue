		...
		<div class="orderEditPage" style="width: 1280px;">
			<el-form :model="ruleForm" :rules="rules" :inline="true" ref="ruleForm" label-width="auto" class="demo-ruleForm" style="margin-left: 10px;">
				<div style="margin-top: -15px;margin-bottom: 20px;">
					<span style="font-size: large;margin-bottom: 20px;">操作订单 - 复制新增</span>
				...
				<el-row>
					<el-col class="elementWidth">
						<el-form-item prop="departureStation">
							<el-input class="widthWithThreeWithXing" v-model="ruleForm.departureStation" clearable @change="sychronizeWareAndStore('update')" auto-complete="off" maxlength="4" style="width: 295px;margin-right: 15px;" @input="ruleForm.departureStation=strTrim(ruleForm.departureStation).toUpperCase()">
								<template slot="prepend">
									<font style="color: red;">*</font>
									<span>始发港</span>
								</template>
					...
					<el-row v-show="showFlag2">
						...
						<el-col class="elementWidth">
							<el-form-item prop="identificationNo">
								<el-input style="width:546px;" class="" @input="ruleForm.identificationNo = ruleForm.identificationNo.toUpperCase()" v-model="ruleForm.identificationNo" auto-complete="off" clearable maxlength="32">
									<template slot="prepend">
										<span>鉴定编号</span>
									</template>
								</el-input>
						...
						<el-tabs style="width: 1103px;height:375px;margin-left: 50px;" type="border-card" v-model="activeOperationName">
							<el-tab-pane name="first">
								...
								<el-row>										
									...
									<el-col class="elementWidth">
										<el-form-item>
											<el-input class="showWordLimit" :disabled="!ruleForm.pickUpDeliveryService" v-model="ruleForm.pickUpDriverTel" auto-complete="off" style="width:365px;" clearable show-word-limit maxlength="20">
												<template slot="prepend">
													<span>提货司机联系方式</span>
												</template>
											</el-input>
							...
							<el-tab-pane name="third">
								...
								<el-row>
									...
									<el-col class="elementWidth">
										<el-form-item>
											<el-input class="showWordLimit" :disabled="!ruleForm.outfieldService" v-model="ruleForm.outfieldDeliveryDriverTel" auto-complete="off" style="width:335px;margin-right: 15px;" clearable show-word-limit maxlength="20">
												<template slot="prepend">
													<span>司机联系方式</span>
												</template>
											</el-input>
									...
									<el-col class="elementWidth">
										<el-form-item>
											<el-input class="widthWithSix"style="width:335px;">
												<template slot="prepend">
													<span>入区预约时间</span>
												</template>
												<el-date-picker :disabled="!ruleForm.outfieldService" slot="suffix" v-model="ruleForm.outfieldDeliveryArriveTime" type="datetime" value-format="yyyy-MM-dd HH:mm:ss" placeholder="选择时间" style="width: 228px;margin-right: -5px;">
												</el-date-picker>
											</el-input>
										</el-form-item>
									</el-col>
