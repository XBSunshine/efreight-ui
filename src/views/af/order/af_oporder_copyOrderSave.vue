...
export default {
  ...
  methods: {
    ...
    setValue(rrow) {
      ...
      this.$axios.get("/prm/coop/" + rrow.coopId).then((response) => {
        if (
          ...
          response.data.data.transactor_id != null
        ) {
    ...
    setgoodsTypeOptions(departureStation,flag) {
    ...
    setcheck3NULL() {
      ...
      this.ruleForm.wareName ="";
      this.ruleForm.cargoType ="";
      this.ruleForm.specialHandleCodeM3="";
      this.ruleForm.packSize = "";
    },
    setcheck4NULL() {
