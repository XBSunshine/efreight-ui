                    ...
                    <a class="label" href="javascript:void(0)" @click="getTact" style="color: #137DFA;text-decoration: underline;">Rate/Charge</a>
								...
								<div id="item-body">
									<div id="item-record">
										...
										<div id="kg-lb" class="horizontal">
											<input v-model="ruleForm.sel_wci_unit" name="sel_wci_unit" class="TextBox nohelp" id="sel_wci_unit" style="display: none;" @change="ruleForm.sel_wci_unit=strTrim(ruleForm.sel_wci_unit).toUpperCase()">K
										</div>
										<div class="space horizontal"></div>
										<div id="rate-class" class="horizontal">
										...
										<div class="space horizontal"></div>
										<div id="goods" class="horizontal">
											<textarea v-model="ruleForm.goodsDescription" id="GoodsDescription" maxlength="1500" name="GoodsDescription" rows="4" cols="61" @change="ruleForm.goodsDescription=strTrim(ruleForm.goodsDescription).toUpperCase()"></textarea>
										</div>
									</div>
									<div id="item-record">
										<div id="pieces" class="horizontal">
...
<script>
	...
	export default {
		...
		methods: {
          ...
          if(response.data.data.afOrderShipperConsignee2 == null){
              this.ruleForm.afOrderShipperConsignee2 = {};
					...
					if (response.data.data.executedAt) {
						this.ruleForm.executedAt = response.data.data.executedAt.toUpperCase()
					}
					if (response.data.data.goodsDescription) {
						this.ruleForm.goodsDescription = response.data.data.goodsDescription.toUpperCase()
					}
          if (response.data.data.departureStationName) {
              this.ruleForm.departureStationName = response.data.data.departureStationName.toUpperCase()
          }
					this.init()
				}).catch((error) => {
					console.log(error);
      ...
      openError1(info) {
        ...
        if(this.frow.awbNumber){
            this.ffrow.awbNumberPrefix = this.frow.awbNumber.substring(0,3);
        }else{
            this.ffrow.awbNumberPrefix = '';
        }
      ...
      getTact(){
          let awbNumberPrefix
          if(this.frow.awbNumber){
              awbNumberPrefix = this.frow.awbNumber.substring(0,3);
          }else{
              awbNumberPrefix = '';
          }
          if(this.ruleForm.departureStation == null || this.ruleForm.departureStation == ''){
          ...
          let param = "awbNumberPrefix=" + awbNumberPrefix + "&departureStation=" + this.ruleForm.departureStation +
