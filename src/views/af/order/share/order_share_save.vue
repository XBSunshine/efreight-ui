		...
		<div class="orderEditPage" style="width: 1280px;">
			<el-form :model="ruleForm" :rules="rules" :inline="true" ref="ruleForm" label-width="100px" class="demo-ruleForm" style="margin-left: 10px;">
				<div style="margin-top: -15px;margin-bottom: 20px;">
					<span style="font-size: large;margin-bottom: 20px;">协作订单</span>
				...
				<el-row>
					<el-col class="elementWidth">
						<el-form-item prop="awbNumber">
							<el-input v-model="ruleForm.awbNumber" clearable maxlength="12" @input="formatToFloat('awbNumber')" auto-complete="off" style="width:295px;margin-right: 15px;">
								<template slot="prepend">
									<span>主运单号</span>
								</template>
          ...
          <el-col class="elementWidth">
            <el-form-item>
              <el-input auto-complete="off" style="width:295px;margin-right: 15px;" clearable>
                ...
                <el-select slot="suffix" clearable  maxlength='4'  remote :filter-method="searchAirport" filterable  :loading="loading" v-model="ruleForm.departureStation"
                ...
                <el-select slot="suffix"  maxlength="4"  remote :filter-method="searchAirport" filterable  :loading="loading" v-model="ruleForm.arrivalStation"
                ...
                <el-select slot="suffix" clearable maxlength="4"   remote :filter-method="searchAirport" filterable  :loading="loading" v-model="ruleForm.transitStation"
                ...
                <el-select slot="suffix" maxlength="4" clearable  remote :filter-method="searchAirport" filterable  :loading="loading" v-model="ruleForm.transitStation2"
                ...
                <el-select slot="suffix" maxlength="5" clearable  remote :filter-method="searchCity" filterable  :loading="loading" v-model="ruleForm.goodsSourceCode"
          ...
          <el-row v-show="showFlag2">
            <el-col class="elementWidth afOrderLinkTwoInput" style="margin-left: 50px;">
              <el-form-item prop="palletMaterial">
				...
				<el-row>
					<el-form-item>
						<el-button :loading="loading" :disabled="disabledFlagTwo" type="primary" size="small" @click="sureSubmitForm('ruleForm')">保存</el-button>
					</el-form-item>
				</el-row>
			</el-form>
...
<script>
    ...
    // inject: ['findByPage', 'continueOperation'],
      ...
      findByPage(){},
			...
			awbNumberSelectCallBack(val) {
				...
				this.ruleForm.shipperLetters.forEach(shipperLetter => {
					shipperLetter.awbNumber = val.awbNumber
				})
			},
			gotoSizePage() {
			...
			submitForm3(formName) {
				...
				this.$refs[formName].validate((valid) => {
                  ...
                  this.disabledFlagTwo = true;
                    ...
                    this.ffrow.coopId = this.ruleForm.coopOrgCoopId;
                    this.ffrow.coopName = this.ruleForm.coopName;
                    this.ffrow.shareOrderSave = 1;
      ...
      //根据配置的分享字段显示
      clearSharefields(row){
         if(this.ruleForm.sharefields.indexOf('主运单号')>-1&&this.ruleForm.sharefieldsTwo.indexOf('主运单号')>-1){
             this.ruleForm.awbNumber = row.awbNumber;
         }
         if(this.ruleForm.sharefields.indexOf('客户单号')>-1&&this.ruleForm.sharefieldsTwo.indexOf('客户单号')>-1){
             this.ruleForm.customerNumber = row.customerNumber;
         }
         if(this.ruleForm.sharefields.indexOf('始发港')>-1&&this.ruleForm.sharefieldsTwo.indexOf('始发港')>-1){
             this.ruleForm.departureStation = row.departureStation;
         }
         if(this.ruleForm.sharefields.indexOf('目的港')>-1&&this.ruleForm.sharefieldsTwo.indexOf('目的港')>-1){
             this.ruleForm.arrivalStation = row.arrivalStation;
         }
         if(this.ruleForm.sharefields.indexOf('航班号')>-1&&this.ruleForm.sharefieldsTwo.indexOf('航班号')>-1){
             this.ruleForm.expectFlight = row.expectFlight;
         }
         if(this.ruleForm.sharefields.indexOf('航班日期')>-1&&this.ruleForm.sharefieldsTwo.indexOf('航班日期')>-1){
             this.ruleForm.expectDeparture = row.expectDeparture;
         }
         if(this.ruleForm.sharefields.indexOf('中转港1')>-1&&this.ruleForm.sharefieldsTwo.indexOf('中转港1')>-1){
             this.ruleForm.transitStation = row.transitStation;
         }
         if(this.ruleForm.sharefields.indexOf('中转港2')>-1&&this.ruleForm.sharefieldsTwo.indexOf('中转港2')>-1){
             this.ruleForm.transitStation2 = row.transitStation2;
         }
         if(this.ruleForm.sharefields.indexOf('预报件数')>-1&&this.ruleForm.sharefieldsTwo.indexOf('预报件数')>-1){
             this.ruleForm.planPieces = row.planPieces;
         }
         if(this.ruleForm.sharefields.indexOf('包装')>-1&&this.ruleForm.sharefieldsTwo.indexOf('包装')>-1){
             this.ruleForm.packageType = row.packageType;
         }
         if(this.ruleForm.sharefields.indexOf('预报毛重')>-1&&this.ruleForm.sharefieldsTwo.indexOf('预报毛重')>-1){
             this.ruleForm.planWeight = row.planWeight;
         }
         if(this.ruleForm.sharefields.indexOf('预报体积')>-1&&this.ruleForm.sharefieldsTwo.indexOf('预报体积')>-1){
             this.ruleForm.planVolume = row.planVolume;
         }
         if(this.ruleForm.sharefields.indexOf('预报计重')>-1&&this.ruleForm.sharefieldsTwo.indexOf('预报计重')>-1){
             this.ruleForm.planChargeWeight = row.planChargeWeight;
         }
         if(this.ruleForm.sharefields.indexOf('预报尺寸')>-1&&this.ruleForm.sharefieldsTwo.indexOf('预报尺寸')>-1){
             this.ruleForm.planDimensions = row.planDimensions;
         }
         if (this.ruleForm.planVolume != null && this.ruleForm.planVolume !== '' && parseFloat(this.ruleForm.planVolume + '') != 0 && this.ruleForm.planWeight != null && this.ruleForm.planWeight !== '') {
         	this.ruleForm.planDensity = parseFloat(this.ruleForm.planWeight + '') / parseFloat(this.ruleForm.planVolume + '') + ''
         	this.ruleForm.planDensity = this.ruleForm.planDensity.split('.')[0]
         }
         if(this.ruleForm.sharefields.indexOf('货源地')>-1&&this.ruleForm.sharefieldsTwo.indexOf('货源地')>-1){
             this.ruleForm.goodsSourceCode = row.goodsSourceCode;
         }
         if(this.ruleForm.sharefields.indexOf('主单信息')>-1&&this.ruleForm.sharefieldsTwo.indexOf('主单信息')>-1){
             this.ruleForm.afOrderShipperConsignee2  = row.afOrderShipperConsignee2;
             if(this.ruleForm.afOrderShipperConsignee2.scType!=0){
             ...
             this.ruleForm.afOrderShipperConsignee1  = row.afOrderShipperConsignee1;
             if(this.ruleForm.afOrderShipperConsignee1.scType!=1){
             ...
             this.ruleForm.goodsNameCn = row.goodsNameCn;
             this.ruleForm.goodsNameEn = row.goodsNameEn;
             this.ruleForm.notifierRemark = row.notifierRemark;
             this.ruleForm.arrivalAgent = row.arrivalAgent;
             this.ruleForm.shippingMarks = row.shippingMarks;
             this.ruleForm.handlingInfo = row.handlingInfo;
         }
         if(this.ruleForm.sharefields.indexOf('全部分单信息')>-1&&this.ruleForm.sharefieldsTwo.indexOf('全部分单信息')>-1){
             this.ruleForm.shipperLetters=row.shipperLetters;
             this.ruleForm.hawbQuantity = this.ruleForm.shipperLetters.length;
             if (this.ruleForm.hawbQuantity == 0) {
             	this.ruleForm.hawbFlag = '直单';
             } else {
         ...
         if(this.ruleForm.sharefields.indexOf('货物类型')>-1&&this.ruleForm.sharefieldsTwo.indexOf('货物类型')>-1){
             this.ruleForm.goodsType=row.goodsType;
         }else{
             this.ruleForm.goodsType = this.defInfoOrg.goodsType;
         }
         if(this.ruleForm.sharefields.indexOf('电池情况')>-1&&this.ruleForm.sharefieldsTwo.indexOf('电池情况')>-1){
             this.ruleForm.batteryType=row.batteryType;
         }else{
             this.ruleForm.batteryType=this.defInfoOrg.batteryType
         }
         if(this.ruleForm.sharefields.indexOf('海关代码')>-1&&this.ruleForm.sharefieldsTwo.indexOf('海关代码')>-1){
             this.ruleForm.customsStatusCode=row.customsStatusCode;
         }else{
             this.ruleForm.customsStatusCode = this.defInfoOrg.customsStatusCode;
         }
         if(this.ruleForm.sharefields.indexOf('随机文件')>-1&&this.ruleForm.sharefieldsTwo.indexOf('随机文件')>-1){
             this.ruleForm.airborneDocument=row.airborneDocument;
         }
         if(this.ruleForm.sharefields.indexOf('鉴定单位')>-1&&this.ruleForm.sharefieldsTwo.indexOf('鉴定单位')>-1){
             this.ruleForm.appraisalCompany=row.appraisalCompany;
         }
         if(this.ruleForm.sharefields.indexOf('危品类项')>-1&&this.ruleForm.sharefieldsTwo.indexOf('危品类项')>-1){
             this.ruleForm.dangerousType=row.dangerousType;
         }
         if(this.ruleForm.sharefields.indexOf('鉴定号')>-1&&this.ruleForm.sharefieldsTwo.indexOf('鉴定号')>-1){
             this.ruleForm.appraisalNote=row.appraisalNote;
         }
          if(this.ruleForm.sharefields.indexOf('托盘材质')>-1&&this.ruleForm.sharefieldsTwo.indexOf('托盘材质')>-1){
              this.ruleForm.palletMaterial=row.palletMaterial;
          }
          if(this.ruleForm.sharefields.indexOf('特货包装')>-1&&this.ruleForm.sharefieldsTwo.indexOf('特货包装')>-1){
              this.ruleForm.specialPackage=row.specialPackage;
          }
          if(this.ruleForm.sharefields.indexOf('温度要求')>-1&&this.ruleForm.sharefieldsTwo.indexOf('温度要求')>-1){
              this.ruleForm.celsiusRequire=row.celsiusRequire;
          }
          if(this.ruleForm.sharefields.indexOf('温度计')>-1&&this.ruleForm.sharefieldsTwo.indexOf('温度计')>-1){
              this.ruleForm.thermometer=row.thermometer;
          }
      },
      /**
       * 通用搜索方法
        ...
        this.$axios.get('/hrs/org/getOrgOrderConfig/AE').then((response) => {
          ...
          this.defInfoOrg.customsStatusCode = '001'
			...
			this.$axios.get('/afbase/aforder/view/' + this.frow.orderId)
				.then(function(response) {
          let resultDate = response.data.data;
              ...
              if(r!=null&&r.length>0){
                this.$axios.get2('/afbase/afOrderShare/shareFieldsTwo/'+this.frow.shareOrgId+'/'+ this.frow.coopOrgCoopId).then((response) => {
                    ...
                    if(q!=null&&r.length>0){
                      this.ruleForm.sharefieldsTwo = q.toString();
                      this.ruleForm.sharefields = r.toString();
                      this.clearSharefields(resultDate);
                      this.ruleForm.sharefields = '';
                      this.ruleForm.sharefieldsTwo = '';
                    }
                }).catch((error) => {
                    console.log(error);
                });
          ...
          //客服跟销售当前用户
          this.ruleForm.servicerId = parseInt(localStorage.getItem("userId"));
          //查询当前客服所在的工作组
          this.$axios.get('/hrs/userWorkgroup/selectWorkgroupByServicerId?servicerId='+this.ruleForm.servicerId).then(function(response) {
              let userWorkgroupDetailList1 = response.data.data;
              if(userWorkgroupDetailList1 != null && userWorkgroupDetailList1.length > 0){
          ...
          this.ruleForm.salesId = parseInt(localStorage.getItem("userId"));
         // this.ruleForm.servicerName = localStorage.getItem("nickname");
          //this.ruleForm.salesName = localStorage.getItem("nickname");
          this.ruleForm.orderShareOrgId = this.frow.orderOrgId;
          this.ruleForm.orderShareOrderId = this.frow.orderId;
          this.ruleForm.orderShareCoopId = this.frow.shareCoopId;
          // 查找绑定的coopOrgCoopId
          this.$axios.get2('/prm/coop/'+this.frow.coopOrgCoopId).then((response) => {
              let r = response.data.data;
              if(r!=null){
                // console.log(r);
               this.ruleForm.coopId = r.coop_id;
               this.ruleForm.coopOrgCoopId = r.coop_id;
               // this.ruleForm.coopOrgCoopName = r.coop_name;
               this.ruleForm.coopName = r.coop_name;
               let params = {
               	coopId: this.ruleForm.coopId
               };
               this.$axios.get2('/prm/coop/queryContactsIsValid',params).then(function(response) {
               		this.contactsOptions = response.data.data;
               	}.bind(this))
              }
          }).catch((error) => {
