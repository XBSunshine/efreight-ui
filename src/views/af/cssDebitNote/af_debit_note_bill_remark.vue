<template>
	<el-dialog title="发票信息" width="650px" :visible.sync="visible" :close-on-press-escape="false" :close-on-click-modal="false" :before-close="handleClose" append-to-body>
...
<script>
	export default {
		...
		created: function() {
			this.ruleForm.debitNoteId = this.frow.debitNoteId;
      ...
      getDateTime() {
          ...
          return _year + "-" + _month + "-" + _date
			...
			doSave(formName) {
				...
				this.$axios.post2('/afbase/cssDebitNote/doEditInvoiceRemark', this.ruleForm)
