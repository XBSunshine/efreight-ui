<template>
	<el-dialog title="上传文件" width="650px" :visible.sync="visible" :close-on-press-escape="false" :close-on-click-modal="false" :before-close="handleClose" append-to-body>
		<el-upload v-if="!loading" class="upload-demo" :action="actionPath" :data="param" :accept="accept" :on-preview="handlePreview" :on-success="uploadSuccess" :before-upload="beforeUpload" :on-remove="handleRemove" list-type="picture-card" :show-file-list=false>
