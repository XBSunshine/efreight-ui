<template>
	<el-dialog title="单证制作 - 主单详情" top="1vh" width="1100px" :visible.sync="visible" :close-on-press-escape="false" :close-on-click-modal="false" :before-close="handleClose">
		<form>
			<div id="form-container" class="awb_body">
				<div id="form-main">
					<div id="form-title" class="horizontal">
						...
						<el-button style="margin-left: 640px;" type="primary" size="small" @click="printG">格打</el-button>
						<el-button style="margin-left: 5px;" type="primary" size="small" @click="printT">套打</el-button>
						<el-button style="margin-left: 5px;" type="primary" size="small" @click="sendMawb" v-if="sendMawbFlag">发送AMS</el-button>
						...
						<div id="form-right">
							<div id="mawb">
								<div>
									...
									<span id="showprex" class="awb_code">{{ruleForm.awbNumber}}</span>
