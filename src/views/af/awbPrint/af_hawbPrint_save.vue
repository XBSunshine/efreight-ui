<template>
	<el-dialog title="单证制作 - 制分单" top="1vh" width="1100px" :visible.sync="visible" :close-on-press-escape="false" :close-on-click-modal="false" :before-close="handleClose">
		<form>
				...
				this.$axios.post2('/afbase/awbPrint/hawb', this.ruleForm)
					.then(function(response) {
						if(response.data.code == 0) {
							...
							this.queryList();
							//							this.handleClose();
							this.frow.awbPrintId = response.data.data
							this.saveToEdit(this.frow, 'hawb')
						} else {
