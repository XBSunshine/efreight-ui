			...
			<div id="form-container" class="awb_body">
				<div id="form-main">
					<div id="form-title" class="horizontal">
						...
						<div style="margin-left: 450px;display: inline;">
							<el-button :loading="loading" type="primary" size="small" @click="modify" v-if="editMawbFlag">修改</el-button>
							<el-button :loading="loading1" style="margin-left: 5px;" type="primary" size="small" @click="awbFinish" v-if="finishMawbFlag">主单完成</el-button>
...
<!--							<el-button style="margin-left: 5px;" type="primary" size="small" @click="sendMawb" v-if="sendMawbFlag">发送主单</el-button>
							...
							<div id="item-detail">
								...
								<div id="item-body">
									...
									<div id="item-summary">
										...
										<div id="gross-weight" class="horizontal">
											<input v-model="ruleForm.TotalGrossWeight" id="TotalGrossWeight" name="TotalGrossWeight" class="TextBox" style="display: none;">
										</div>
										<div id="kg-lb" class="horizontal">
										</div>
										<div class="space horizontal"></div>
				...
				this.$axios.put('/afbase/awbPrint/finish/mawb', this.ruleForm)
					.then(function(response) {
						if(response.data.code == 0) {
							this.openSuccess("修改成功！");
							this.queryList();
							this.editToView(this.frow, 'mawb')
						} else {
							this.openError(response.data.messageInfo);
						}
						this.loading1 = false
