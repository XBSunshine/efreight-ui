      ...
      if(a){
        ...
        let param = {
          ...
          endDate:this.query.flightDateEnd
				...
				if (val == 'KH') {
           this.$router.push('/css_p_report_customer_contribution?o='+this.base64Encode(JSON.stringify(param)))
				}else if(val == 'GYS'){
           this.$router.push('/css_report_supplier_procurement?o='+this.base64Encode(JSON.stringify(param)))
        }else if(val == 'HX'){
          if(this.query.orderStatus){
           ...
           this.$router.push('/customer_info_menu?name=more&flag=true&frow='+this.base64Encode(JSON.stringify(param)))
        } else {
