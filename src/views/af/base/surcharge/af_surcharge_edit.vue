<template>
  <el-dialog title="附加费 - 编辑" width="700px" :visible.sync="visible" :close-on-press-escape="false" :close-on-click-modal="false" :before-close="handleClose">
    <el-form :disabled="loading" :model="ruleForm" :rules="rules" :close-on-press-escape="false" ref="ruleForm" label-width="85px" style="margin-left: 10px;" class="afSurchargeEdit">
      <el-row>
        ...
        <el-col class="elementWidth">
          <el-form-item prop="arrivalNationCode" label-width="15px">
            <el-input class="widthThree" style="width:239px;margin-right: 15px;">
              ...
              <el-select slot="suffix" v-model="ruleForm.arrivalNationCodes" multiple filterable placeholder="请选择" style="width:146px;margin-right: -5px;">
...
<script>
    export default {
        ...
        created(){
            ...
            this.view(this.frow.surchargeId)
        },
        ...
        methods: {
            ...
            submitForm(formName) {
                ...
                if((this.ruleForm.arrivalStations.length == 0) && (this.ruleForm.arrivalNationCodes.length == 0) && (this.ruleForm.routingName == null || this.ruleForm.routingName == '')){
                ...
                this.$refs[formName].validate((valid) => {
                    if(valid) {
                        ...
                        this.$axios.post2("/afbase/surcharge/doUpdate", params)
                            .then(function(response) {
            ...
            resetForm(formName) {
                ...
                this.ruleForm.arrivalNationCodes = [];
            ...
            view(id) {
              this.$axios.get('/afbase/surcharge/' + this.frow.surchargeId)
                  .then((response) => {
                      this.ruleForm = response.data.data
                      if (this.ruleForm.arrivalNationCodes == null) {
                          this.ruleForm.arrivalNationCodes = []
                      }
                      if (this.ruleForm.arrivalStations == null) {
                          this.ruleForm.arrivalStations = []
                      }
                      if (this.ruleForm.departureStations == null) {
                          this.ruleForm.departureStations = []
                      }
                  });
            }
