<template>
	<el-dialog title="运单管理——预订" width="45%" :visible.sync="visible" :close-on-press-escape="false" :close-on-click-modal="false" :before-close="handleClose" append-to-body>
		<div>
...
<script>
    ...
    created: function(){
      this.ruleForm.awbIds=this.frow.awbIds;
    ...
    methods: {
      ...
      doSelect(rrow){
        this.ruleForm.reservedCoopId=rrow.coopIdV;
        this.ruleForm.reservedCoopName=rrow.coopNameV;
        this.$axios.post2('/afbase/awb/bookAwbList', this.ruleForm)
